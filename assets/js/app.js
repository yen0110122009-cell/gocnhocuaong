...
function applyPerfPagination(){
  const targets=[
    ...
    ['studyAiFlashcardList',':scope > .study-ai-card','study-ai-flashcards',10,'flashcard'],
    ['studyAiExamList',':scope > .study-ai-card','study-ai-exams',10,'đề thi'],
...
function renderCurrentTab(){
  ...
  switch(tab){
    ...
    case 'studyAi-flashcards':if(typeof renderFlashcards==='function')renderFlashcards(data.flashcards?.at(-1)?.items||[]);break;
...
/* ---- extracted script block 10: <script id="public-content-visibility-guard-v1"> ---- */
(function(){
