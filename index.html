...
<title>🌷 Góc nhỏ của Ong 🐝</title>
<style>
:root{
  --red:#ff4d6d;--red2:#ff758f;--pink:#fff0f3;--green:#2d6a4f;--green-dark:#1b4332;--green-light:#d8f3dc;
  --cream:#fffaf6;--ink:#212529;--muted:#6c757d;--line:#dee2e6;--card:#fff;
  --shadow:0 10px 30px rgba(255, 77, 109, .08);--radius:20px;
  --bg-gradient:linear-gradient(135deg,#fff0f3,#d8f3dc);
}
body.mood-vui { --green:#2d6a4f; --bg-gradient:linear-gradient(135deg,#fff0f3,#d8f3dc); }
body.mood-binh-thuong { --green:#3a86ff; --bg-gradient:linear-gradient(135deg,#f0f4f8,#e0fbfc); }
body.mood-met { --green:#6c757d; --bg-gradient:linear-gradient(135deg,#f8f9fa,#e9ecef); }
body.mood-quyet-tam { --green:#ff0054; --bg-gradient:linear-gradient(135deg,#ffe5ec,#ffccd5); }
body.mood-tut-mood, body.mood-sad { --green:#00b4d8; --bg-gradient:linear-gradient(135deg, #0077b6, #00b4d8, #5390d9, #7209b7); }
/* 🌈 NHIỀU CẢM XÚC HIỆN TẠI — chỉ đổi giao diện, không lưu lịch sử */
body.theme-vui { --green:#2d6a4f; --bg-gradient:linear-gradient(135deg,#fff0f3,#d8f3dc,#fefae0); }
body.theme-binh-yen { --green:#3a86ff; --bg-gradient:linear-gradient(135deg,#e0fbfc,#caf0f8,#f1f7ff); }
body.theme-buon { --green:#0077b6; --bg-gradient:linear-gradient(135deg,#dbeafe,#93c5fd,#c4b5fd); }
body.theme-dau-long { --green:#b4235a; --bg-gradient:linear-gradient(135deg,#ffe4e6,#fecdd3,#e9d5ff); }
body.theme-lo-lang { --green:#7c5cff; --bg-gradient:linear-gradient(135deg,#ede9fe,#ddd6fe,#dbeafe); }
body.theme-tuc-gian { --green:#dc2626; --bg-gradient:linear-gradient(135deg,#fee2e2,#fecaca,#ffedd5); }
body.theme-met-moi { --green:#6b7280; --bg-gradient:linear-gradient(135deg,#f3f4f6,#e5e7eb,#d1d5db); }
body.theme-co-don { --green:#5b4b8a; --bg-gradient:linear-gradient(135deg,#ede9fe,#c4b5fd,#dbeafe); }
body.theme-hy-vong { --green:#16a34a; --bg-gradient:linear-gradient(135deg,#dcfce7,#bbf7d0,#fef9c3); }
body.theme-hung-khoi { --green:#f97316; --bg-gradient:linear-gradient(135deg,#ffedd5,#fed7aa,#fef3c7); }
body.theme-tap-trung { --green:#2563eb; --bg-gradient:linear-gradient(135deg,#dbeafe,#bfdbfe,#e0f2fe); }
body.theme-biet-on { --green:#15803d; --bg-gradient:linear-gradient(135deg,#dcfce7,#d1fae5,#fef3c7); }
body.theme-yeu-doi { --green:#ec4899; --bg-gradient:linear-gradient(135deg,#fce7f3,#fbcfe8,#ede9fe); }
body.theme-phat-khoc { --green:#4f46e5; --bg-gradient:linear-gradient(135deg,#e0e7ff,#c7d2fe,#dbeafe); }
body.theme-phat-cuong { --green:#e11d48; --bg-gradient:linear-gradient(135deg,#ffe4e6,#fecdd3,#fed7aa); }
body.theme-thu-gian { --green:#0f766e; --bg-gradient:linear-gradient(135deg,#ccfbf1,#d1fae5,#e0f2fe); }
body.theme-chan-nan { --green:#64748b; --bg-gradient:linear-gradient(135deg,#e2e8f0,#cbd5e1,#e5e7eb); }
body.theme-tu-hao { --green:#ca8a04; --bg-gradient:linear-gradient(135deg,#fef9c3,#fde68a,#fed7aa); }
body.theme-xau-ho { --green:#be185d; --bg-gradient:linear-gradient(135deg,#fce7f3,#fbcfe8,#ffe4e6); }
body.theme-bat-an { --green:#7e22ce; --bg-gradient:linear-gradient(135deg,#f3e8ff,#e9d5ff,#ddd6fe); }
body.theme-ngac-nhien { --green:#0891b2; --bg-gradient:linear-gradient(135deg,#cffafe,#a5f3fc,#dbeafe); }
body.theme-buc-boi { --green:#ea580c; --bg-gradient:linear-gradient(135deg,#ffedd5,#fed7aa,#fecaca); }
body.theme-chanh-long { --green:#0f766e; --bg-gradient:linear-gradient(135deg,#ccfbf1,#99f6e4,#cffafe); }
body.theme-mat-mat { --green:#475569; --bg-gradient:linear-gradient(135deg,#e2e8f0,#cbd5e1,#dbeafe); }
body.theme-co-dong-luc { --green:#7c3aed; --bg-gradient:linear-gradient(135deg,#ede9fe,#ddd6fe,#fce7f3); }
body.theme-yeu-doi-ban-than { --green:#db2777; --bg-gradient:linear-gradient(135deg,#fce7f3,#fbcfe8,#dcfce7); }
body.theme-vui,body.theme-binh-yen,body.theme-buon,body.theme-dau-long,body.theme-lo-lang,body.theme-tuc-gian,body.theme-met-moi,body.theme-co-don,body.theme-hy-vong,body.theme-hung-khoi,body.theme-tap-trung,body.theme-biet-on,body.theme-yeu-doi,body.theme-phat-khoc,body.theme-phat-cuong,body.theme-thu-gian,body.theme-chan-nan,body.theme-tu-hao,body.theme-xau-ho,body.theme-bat-an,body.theme-ngac-nhien,body.theme-buc-boi,body.theme-chanh-long,body.theme-mat-mat,body.theme-co-dong-luc,body.theme-yeu-doi-ban-than{--theme-pale:color-mix(in srgb,var(--theme-primary) 10%,white);--theme-soft:color-mix(in srgb,var(--theme-primary) 18%,white);--theme-line:color-mix(in srgb,var(--theme-primary) 35%,#dee2e6);--theme-shadow:0 10px 28px color-mix(in srgb,var(--theme-primary) 18%,transparent);--theme-glow:0 0 0 3px color-mix(in srgb,var(--theme-primary) 16%,transparent);--red:var(--theme-primary);--red2:var(--theme-secondary);--pink:var(--theme-pale);--green:var(--theme-primary);--green-dark:color-mix(in srgb,var(--theme-primary) 75%,black);--green-light:var(--theme-soft);--line:var(--theme-line);--shadow:var(--theme-shadow)}
body.theme-vui{--theme-primary:#2d6a4f;--theme-secondary:#52b788}
body.theme-binh-yen{--theme-primary:#3a86ff;--theme-secondary:#74c0fc}
body.theme-buon{--theme-primary:#0077b6;--theme-secondary:#5390d9}
body.theme-dau-long{--theme-primary:#b4235a;--theme-secondary:#e11d48}
body.theme-lo-lang{--theme-primary:#7c5cff;--theme-secondary:#a78bfa}
body.theme-tuc-gian{--theme-primary:#dc2626;--theme-secondary:#f97316}
body.theme-met-moi{--theme-primary:#6b7280;--theme-secondary:#9ca3af}
body.theme-co-don{--theme-primary:#5b4b8a;--theme-secondary:#8b5cf6}
body.theme-hy-vong{--theme-primary:#16a34a;--theme-secondary:#84cc16}
body.theme-hung-khoi{--theme-primary:#f97316;--theme-secondary:#f59e0b}
body.theme-tap-trung{--theme-primary:#2563eb;--theme-secondary:#06b6d4}
body.theme-biet-on{--theme-primary:#15803d;--theme-secondary:#65a30d}
body.theme-yeu-doi{--theme-primary:#ec4899;--theme-secondary:#a855f7}
body.theme-phat-khoc{--theme-primary:#4f46e5;--theme-secondary:#7c3aed}
body.theme-phat-cuong{--theme-primary:#e11d48;--theme-secondary:#f97316}
body.theme-thu-gian{--theme-primary:#0f766e;--theme-secondary:#14b8a6}
body.theme-chan-nan{--theme-primary:#64748b;--theme-secondary:#94a3b8}
body.theme-tu-hao{--theme-primary:#ca8a04;--theme-secondary:#f59e0b}
body.theme-xau-ho{--theme-primary:#be185d;--theme-secondary:#ec4899}
body.theme-bat-an{--theme-primary:#7e22ce;--theme-secondary:#a855f7}
body.theme-ngac-nhien{--theme-primary:#0891b2;--theme-secondary:#06b6d4}
body.theme-buc-boi{--theme-primary:#ea580c;--theme-secondary:#f97316}
body.theme-chanh-long{--theme-primary:#0f766e;--theme-secondary:#14b8a6}
body.theme-mat-mat{--theme-primary:#475569;--theme-secondary:#64748b}
body.theme-co-dong-luc{--theme-primary:#7c3aed;--theme-secondary:#ec4899}
body.theme-yeu-doi-ban-than{--theme-primary:#db2777;--theme-secondary:#ec4899}
/* Theme thật sự phủ lên cả các nút/icon, không chỉ nền trang */
body{transition:background .55s ease,color .35s ease}
body .mood-btn{border-color:var(--theme-line,var(--line));background:linear-gradient(135deg,var(--theme-pale,#fff),var(--theme-soft,#f8f9fa));box-shadow:0 5px 16px color-mix(in srgb,var(--theme-primary,var(--red)) 8%,transparent)}
body .mood-btn:hover{border-color:var(--theme-primary,var(--red));background:linear-gradient(135deg,var(--theme-soft,#fff),color-mix(in srgb,var(--theme-secondary,var(--red2)) 16%,white));box-shadow:var(--theme-glow,0 0 0 3px rgba(0,0,0,.04));transform:translateY(-2px)}
body .mood-btn.selected{border-color:var(--theme-primary,var(--red));background:linear-gradient(135deg,color-mix(in srgb,var(--theme-primary,var(--red)) 18%,white),color-mix(in srgb,var(--theme-secondary,var(--red2)) 16%,white));color:var(--theme-primary,var(--red));box-shadow:var(--theme-glow,0 0 0 3px rgba(0,0,0,.04))}
body .mood-btn .mood-icon{filter:drop-shadow(0 3px 5px color-mix(in srgb,var(--theme-primary,var(--red)) 28%,transparent));transition:transform .35s ease,filter .35s ease}
body .mood-btn:hover .mood-icon,body .mood-btn.selected .mood-icon{transform:scale(1.12)}
nav .navbtn.active,.btn.primary,.btn.danger{background:linear-gradient(135deg,var(--theme-primary,var(--red)),var(--theme-secondary,var(--red2)));border-color:var(--theme-primary,var(--red))}
.navbtn:hover{border-color:var(--theme-primary,var(--red));color:var(--theme-primary,var(--red))}



*{box-sizing:border-box}
body{margin:0;background:var(--bg-gradient);background-size:280% 280%;color:var(--ink);font-family:Inter,system-ui,-apple-system,"Segoe UI",Arial,sans-serif;transition:background .8s ease;animation:themeFlow 16s ease-in-out infinite;position:relative}
@keyframes themeFlow{0%{background-position:0% 30%}25%{background-position:100% 0%}50%{background-position:100% 100%}75%{background-position:0% 100%}100%{background-position:0% 30%}}
@keyframes themeSpin{to{transform:rotate(360deg)}}
body::before{content:"";position:fixed;inset:-20vmax;z-index:-1;pointer-events:none;opacity:.35;filter:blur(60px);
  background:conic-gradient(from 0deg,var(--theme-primary,var(--red)),var(--theme-secondary,var(--red2)),var(--green-light),#ffd166,var(--theme-secondary,var(--red2)),var(--theme-primary,var(--red)));
  animation:themeSpin 26s linear infinite;transition:background 1s ease}
@media (prefers-reduced-motion: reduce){body,body::before{animation:none}}
button,input,select,textarea{font:inherit;transition:border-color .35s ease,box-shadow .35s ease,background .35s ease,color .35s ease}
button{cursor:pointer}
.app{min-height:100vh;max-width:1450px;margin:auto;padding:20px}
header{position:sticky;top:0;z-index:20;background:rgba(255,255,255,.95);backdrop-filter:blur(12px);border-bottom:1px solid var(--line);margin:-20px -20px 20px -20px;padding:14px 20px}
.top{display:flex;gap:16px;align-items:center;justify-content:space-between}
.brand{display:flex;align-items:center;gap:12px}.bee{font-size:34px;background:var(--pink);width:48px;height:48px;display:grid;place-items:center;border-radius:15px;cursor:pointer;user-select:none}.brand h1{margin:0;color:var(--red);font-size:22px}.brand small{color:var(--muted)}
.sponsor-tag{font-size:11px;color:var(--red);font-style:italic;margin-top:2px;display:block}
nav{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}
.navbtn{border:1px solid var(--line);background:#fff;border-radius:12px;padding:9px 12px;color:var(--ink);transition:all .2s}
.navbtn.active{background:var(--red);color:#fff;border-color:var(--red)}
...
.card h2,.card h3{margin:0 0 14px;color:var(--red)}.card h2{font-size:20px}.card h3{font-size:16px}
.hero{background:linear-gradient(120deg,var(--pink),#ffffff);border:1px solid var(--line);border-radius:24px;padding:24px;margin-bottom:18px}
.hero h2{margin:0 0 5px;font-size:26px;color:var(--red)}.hero p{margin:4px 0;color:var(--muted)}
.stat{padding:20px;border-radius:18px;background:#fff5f7;border:1px solid var(--line)}.stat b{display:block;font-size:32px;color:var(--red);margin-top:10px}.stat span{font-size:13px;color:var(--muted)}
.btn{border:0;border-radius:12px;padding:11px 16px;background:var(--red);color:#fff;transition:opacity .2s}.btn:hover{opacity:.9}.btn.light{background:#fff;color:var(--ink);border:1px solid var(--line)}.btn.danger{background:#e63946}.btn.gray{background:#6c757d}.btn.sm{padding:7px 10px;font-size:13px}
.actions{display:flex;gap:8px;flex-wrap:wrap}.muted{color:var(--muted)}.empty{text-align:center;padding:25px;color:var(--muted)}
.form{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.form .full{grid-column:1/-1}
label{font-size:13px;color:var(--muted);display:block;margin-bottom:4px}input,select,textarea{width:100%;border:1px solid var(--line);border-radius:10px;padding:10px;background:#fff;color:var(--ink)}textarea{min-height:90px;resize:vertical}
.tablewrap{overflow:auto;border:1px solid var(--line);border-radius:13px}.table{width:100%;border-collapse:collapse;min-width:720px}.table th,.table td{padding:10px;border-bottom:1px solid var(--line);text-align:left;font-size:13px}.table th{background:var(--pink);color:var(--red)}
.todo{display:flex;align-items:flex-start;gap:10px;padding:12px 0;border-bottom:1px dashed var(--line)}.todo:last-child{border:0}.todo.done .title{text-decoration:line-through;color:var(--muted)}.todo .title{flex:1}.tag{font-size:11px;padding:4px 8px;border-radius:99px;background:var(--green-light);color:var(--green-dark)}.syntax-guide{padding:10px 4px;color:var(--text)}.syntax-guide p{margin:7px 0}.syntax-guide code{display:inline-block;background:#f2f7f3;border:1px solid var(--line);border-radius:8px;padding:5px 7px;white-space:normal}.tag.red{background:#ffe5ec;color:var(--red)}.tag.yellow{background:#fff3b0;color:#b5838d}
.progress{height:9px;background:var(--line);border-radius:99px;overflow:hidden;margin-top:4px}.progress>i{display:block;height:100%;background:linear-gradient(90deg,var(--red),var(--green));border-radius:99px;transition:width .5s ease}
.habit-grid{overflow:auto}.habitrow{display:grid;grid-template-columns:minmax(180px,1fr) repeat(31,28px) 70px;gap:2px;align-items:center;min-width:1150px}.habitrow>div{padding:4px;text-align:center;font-size:11px}.habitrow .name{text-align:left}.check{width:19px;height:19px;border:1px solid var(--line);border-radius:5px;margin:auto;background:#fff;display:grid;place-items:center;cursor:pointer}.check.on{background:var(--red);border-color:var(--red);color:#fff}.monthnav{display:flex;gap:8px;align-items:center;justify-content:space-between;margin-bottom:12px}
.pomo{display:grid;grid-template-columns:1fr 1fr;gap:18px}.clock{font-size:70px;font-weight:800;text-align:center;color:var(--red);padding:24px}.mode{display:flex;justify-content:center;gap:7px}.mode button{border:1px solid var(--line);background:#fff;border-radius:9px;padding:8px}.mode button.active{background:var(--red);color:#fff}
.bar{height:190px;display:flex;align-items:end;gap:10px;border-bottom:1px solid var(--line);padding:10px}.barcol{flex:1;display:flex;flex-direction:column;align-items:center;gap:4px}.barfill{width:100%;max-width:48px;background:linear-gradient(var(--red),var(--green));border-radius:8px 8px 0 0;min-height:2px}.barlabel{font-size:11px}
.quote{background:var(--pink);border-left:4px solid var(--red);padding:14px;border-radius:10px;color:var(--red)}
.mood{display:grid;grid-template-columns:repeat(auto-fit,minmax(118px,1fr));gap:10px;align-items:stretch}
.mood-btn{background:#fff;border:1px solid var(--line);border-radius:14px;padding:10px 12px;cursor:pointer;display:flex;align-items:center;justify-content:flex-start;gap:8px;font-size:15px;line-height:1.2;transition:transform .2s ease,background .3s ease,border-color .3s ease,box-shadow .3s ease;min-height:48px;overflow:hidden}
.mood-btn .mood-icon{font-size:23px;line-height:1;flex:0 0 28px;text-align:center}
.mood-btn .mood-label{white-space:normal;overflow-wrap:anywhere}
.mood-btn:hover{border-color:var(--red);background:var(--pink)}
.mood-btn.selected{background:var(--pink);border-color:var(--red);font-weight:bold}
.modal{position:fixed;inset:0;background:rgba(0,0,0,.45);z-index:50;display:none;align-items:center;justify-content:center;padding:18px}.modal.show{display:flex}.modalbox{background:#fff;border-radius:20px;max-width:720px;width:100%;max-height:90vh;overflow:auto;padding:22px}.modalhead{display:flex;justify-content:space-between;gap:12px;align-items:center}.x{border:0;background:var(--pink);color:var(--red);border-radius:50%;width:34px;height:34px;cursor:pointer}
.trashitem{display:flex;justify-content:space-between;gap:10px;padding:10px;border-bottom:1px solid var(--line)}
.command{font-family:ui-monospace,SFMono-Regular,Consolas,monospace;min-height:130px;background:#212529;color:#f8f9fa;border:0}
.kpi{font-size:13px;color:var(--muted)}.center{text-align:center}

.achievement-list{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}
.achievement{display:flex;align-items:center;gap:13px;padding:14px;border-radius:15px;border:1px solid var(--line);background:#fff5f7}
.achievement.locked{opacity:.45;filter:grayscale(1)}
.achievement-icon{width:46px;height:46px;display:grid;place-items:center;border-radius:13px;background:var(--pink);font-size:23px}

.timeline-item{position:relative;padding-left:24px;border-left:2px solid var(--red);margin-bottom:16px}
.timeline-item::before{content:'';position:absolute;left:-6px;top:4px;width:10px;height:10px;border-radius:50%;background:var(--red)}

/* AUTH & SIDEBAR COLLAPSED MODE */
#authScreen {
  position: fixed; inset: 0; background: var(--bg-gradient); z-index: 100;
  display: flex; align-items: center; justify-content: center; padding: 20px;
}
.auth-box {
  background: #fff; border-radius: 24px; padding: 32px; max-width: 440px; width: 100%;
  box-shadow: 0 20px 40px rgba(0,0,0,0.1); border: 1px solid var(--line); text-align: center;
}
.auth-box h2 { color: var(--red); margin-bottom: 8px; font-size: 24px; }
.auth-box p { color: var(--muted); margin-bottom: 24px; font-size: 14px; }
.auth-inputs { text-align: left; margin-bottom: 20px; }
.auth-inputs label { margin-bottom: 6px; font-weight: 600; }
.auth-inputs input { margin-bottom: 14px; }

@media(max-width:950px){.g4,.g3,.g2{grid-template-columns:1fr}.pomo{grid-template-columns:1fr}.top{align-items:flex-start;flex-direction:column}}

/* =========================================================
   🐝 GIAO DIỆN MỚI — CHỈ LÀ LỚP HIỂN THỊ, KHÔNG ĐỤNG DỮ LIỆU
   ========================================================= */
body.theme-vui{
  --red:#ef233c;--red2:#ff4d6d;--pink:#fff0f3;--green:#2d6a4f;--green-dark:#1b4332;--green-light:#d8f3dc;
  --bg-gradient:linear-gradient(135deg,#fff1f3 0%,#ffffff 48%,#d8f3dc 100%);
}
body.theme-binh-yen{
  --red:#3a7d44;--red2:#57a773;--pink:#edf7ef;--green:#2d6a4f;--green-dark:#1b4332;--green-light:#d8f3dc;
  --bg-gradient:linear-gradient(135deg,#edf7ef,#ffffff,#e7f5e9);
}
body.theme-buon{
  --red:#6c63a8;--red2:#8579c9;--pink:#eeeaff;--green:#527d8a;--green-dark:#31515c;--green-light:#dceff2;
  --bg-gradient:linear-gradient(135deg,#e9e6f8,#f7f8fc,#dceff2);
}
body.theme-dau-long{
  --red:#9b3150;--red2:#c45b78;--pink:#fbe7ed;--green:#5d7770;--green-dark:#354d48;--green-light:#dfece8;
  --bg-gradient:linear-gradient(135deg,#f8dfe7,#fff7f8,#dfece8);
}
body.theme-lo-lang{
  --red:#8a5a00;--red2:#c48700;--pink:#fff4d6;--green:#55745d;--green-dark:#354d3b;--green-light:#e5f0e6;
  --bg-gradient:linear-gradient(135deg,#fff0c7,#fffaf0,#e5f0e6);
}
body.theme-tuc-gian{
  --red:#b42318;--red2:#e04432;--pink:#ffe8e5;--green:#4f6f52;--green-dark:#2f4531;--green-light:#dfece0;
  --bg-gradient:linear-gradient(135deg,#ffdcd8,#fff6f4,#dfece0);
}
body.theme-met-moi{
  --red:#6b7280;--red2:#8b95a3;--pink:#eef0f3;--green:#65756d;--green-dark:#3f4a45;--green-light:#e0e8e3;
  --bg-gradient:linear-gradient(135deg,#e9ecef,#ffffff,#e0e8e3);
}
body.theme-co-don{
  --red:#5865a8;--red2:#7c86c4;--pink:#e9ebfa;--green:#536b75;--green-dark:#35454b;--green-light:#dce8eb;
  --bg-gradient:linear-gradient(135deg,#e4e6f7,#f9f9ff,#dce8eb);
}
body.theme-hy-vong{
  --red:#e07a1f;--red2:#f09a45;--pink:#fff0df;--green:#3f7d58;--green-dark:#285239;--green-light:#dcefe2;
  --bg-gradient:linear-gradient(135deg,#fff0df,#fffdf8,#dcefe2);
}
body.theme-hung-khoi{
  --red:#d94801;--red2:#ff7b00;--pink:#fff0df;--green:#34855b;--green-dark:#20533a;--green-light:#d9f0e1;
  --bg-gradient:linear-gradient(135deg,#ffe7d1,#fffdf8,#d9f0e1);
}
body.theme-tap-trung{
  --red:#b02a37;--red2:#d94d5b;--pink:#fbe9eb;--green:#2f6f55;--green-dark:#204b3a;--green-light:#dcefe5;
  --bg-gradient:linear-gradient(135deg,#f8e0e3,#ffffff,#dcefe5);
}
body.theme-biet-on{
  --red:#8c4a8f;--red2:#b86ab8;--pink:#f6eafa;--green:#47735b;--green-dark:#2d4b3a;--green-light:#e1efe5;
  --bg-gradient:linear-gradient(135deg,#f3e4f5,#fffaff,#e1efe5);
}
/* Theme must reach header, cards, admin panels, buttons and tables. */
header,.card,.stat,.hero,.navbtn,input,select,textarea,.achievement,.table th,.mood-btn,.mode button,.check{transition:background .35s ease,border-color .35s ease,color .35s ease,box-shadow .35s ease}
body.theme-vui .navbtn.active,body.theme-vui .btn,body.theme-vui .check.on{background:var(--red);border-color:var(--red)}
body:not(.theme-vui) .navbtn.active,body:not(.theme-vui) .btn,body:not(.theme-vui) .check.on{background:var(--red);border-color:var(--red)}
body.theme-buon .hero,body.theme-buon .card,body.theme-buon .stat,
body.theme-dau-long .hero,body.theme-dau-long .card,body.theme-dau-long .stat,
body.theme-lo-lang .hero,body.theme-lo-lang .card,body.theme-lo-lang .stat,
body.theme-tuc-gian .hero,body.theme-tuc-gian .card,body.theme-tuc-gian .stat,
body.theme-met-moi .hero,body.theme-met-moi .card,body.theme-met-moi .stat,
body.theme-co-don .hero,body.theme-co-don .card,body.theme-co-don .stat,
body.theme-hy-vong .hero,body.theme-hy-vong .card,body.theme-hy-vong .stat,
body.theme-hung-khoi .hero,body.theme-hung-khoi .card,body.theme-hung-khoi .stat,
body.theme-tap-trung .hero,body.theme-tap-trung .card,body.theme-tap-trung .stat,
body.theme-biet-on .hero,body.theme-biet-on .card,body.theme-biet-on .stat{background:color-mix(in srgb,var(--pink) 78%,#fff 22%)}
/* 🌈 Áp dụng giao diện đồng nhất cho toàn bộ mood mở rộng */
body[class*="theme-"] .hero, body[class*="theme-"] .card, body[class*="theme-"] .stat {
  background: color-mix(in srgb, var(--pink) 78%, #fff 22%);
  transition: background .45s ease, border-color .45s ease, box-shadow .45s ease;
}
body[class*="theme-"] .navbtn.active, body[class*="theme-"] .btn {
  border-color: var(--green);
  background: linear-gradient(135deg, var(--green), color-mix(in srgb, var(--green) 72%, #fff 28%));
  transition: background .45s ease, border-color .45s ease, transform .2s ease;
}

/* 🤖 Các khu vực lệnh vẫn HIỆN để mọi người có thể xem.
   Quyền nhập/chạy lệnh được khóa riêng theo vai trò bằng JavaScript. */
.command{display:block !important;min-height:110px;width:100%;padding:12px;border:1px solid var(--line);border-radius:12px;background:#fff;color:var(--ink);resize:vertical}
.command-panel{display:block}
body[data-role="Guest"] .command{cursor:not-allowed;opacity:.78}
body[data-role="Guest"] input,
body[data-role="Guest"] textarea{cursor:not-allowed}
body[data-role="Guest"] input[readonly],
body[data-role="Guest"] textarea[readonly]{background:#f8faf9}
body[data-role="Guest"] .guest-action-locked{opacity:.58;cursor:not-allowed}
.admin-only-command .command{border-color:var(--green);box-shadow:0 4px 14px rgba(53,77,72,.08)}
/* =========================================================
   🧭 MENU MỚI — CHỈ THU GỌN THANH MENU, KHÔNG ĐỤNG NỘI DUNG
   Bấm một menu: chỉ còn nút đang chọn.
   Bấm lại chính nút đó: toàn bộ menu hiện lại.
   ========================================================= */
#nav{
  flex:1;
  align-items:center;
  ...
  border-radius:18px;
  background:
    linear-gradient(120deg,rgba(255,240,245,.96),rgba(232,250,238,.96),rgba(235,247,255,.96),rgba(248,238,255,.96));
  background-size:300% 300%;
  animation:ongMenuGradient 12s ease infinite;
  border:1px solid rgba(45,106,79,.14);
  box-shadow:0 8px 24px rgba(45,106,79,.10);
...
#nav .navbtn{
  ...
  color:var(--ink);
  box-shadow:0 3px 9px rgba(45,106,79,.06);
  transition:transform .25s ease,background .4s ease,color .25s ease,border-color .25s ease,box-shadow .25s ease;
}
#nav .navbtn::before{
  content:"";
  position:absolute;
...
#nav .navbtn:hover::before{transform:translateX(120%)}
#nav .navbtn:hover{
  transform:translateY(-2px);
  border-color:var(--red);
  box-shadow:0 8px 18px rgba(45,106,79,.14);
}
#nav .navbtn.active{
  color:#fff !important;
  border-color:transparent !important;
  background:linear-gradient(110deg,var(--red),var(--red2),var(--green),#6c63a8,var(--red)) !important;
  background-size:400% 400% !important;
  animation:ongActiveGradient 6s ease infinite !important;
  box-shadow:0 8px 22px rgba(45,106,79,.25) !important;
  transform:translateY(-1px);
}
#nav.compact .navbtn{display:none}
#nav.compact .navbtn.active{
  display:inline-flex;
  align-items:center;
  justify-content:center;
  min-width:150px;
...
#nav.compact .navbtn.active::after{
  content:"↻";
  margin-left:9px;
  font-size:15px;
  opacity:.9;
}
@keyframes ongMenuGradient{
  0%{background-position:0% 50%}
  50%{background-position:100% 50%}
  100%{background-position:0% 50%}
}
@keyframes ongActiveGradient{
  0%{background-position:0% 50%}
  50%{background-position:100% 50%}
  100%{background-position:0% 50%}
}
@media(max-width:950px){
  ...
  #nav.compact{width:max-content;align-self:center}
}
/* 👤 KHÁCH: ĐƯỢC MỞ/XEM TẤT CẢ CÁC TRANG, NHƯNG KHÔNG ĐƯỢC NHẬP/LƯU/CHẠY DỮ LIỆU. */
body[data-role="Guest"] .guest-only-note{display:block!important}
body[data-role="Guest"] #nav .navbtn{display:inline-flex!important}
body[data-role="Guest"] #nav{justify-content:center}
body[data-role="Guest"] .guest-disabled{opacity:.58;cursor:not-allowed}
@media(max-width:600px){
  #nav{gap:5px;padding:6px}
  #nav .navbtn{padding:8px 9px;font-size:12px}
  #nav.compact .navbtn.active{min-width:140px}
}
/* Kho thành tích có thể thu gọn từng tầng. */
#rebuiltAchievementGroups{display:grid;gap:12px}
@media(max-width:700px){.achievement-list{grid-template-columns:1fr}}


.achievement-group{box-shadow:0 8px 22px rgba(0,0,0,.06)} .achievement-tier-icon{width:52px;height:52px;min-width:52px;border-radius:15px;display:grid;place-items:center;font-size:27px;border:2px solid rgba(255,255,255,.85);box-shadow:0 7px 18px rgba(0,0,0,.12)}
.achievement-group[data-tier="de"] .achievement-tier-icon{background:#dff7e7}.achievement-group[data-tier="trung-binh"] .achievement-tier-icon{background:#d8f0ff}.achievement-group[data-tier="kho"] .achievement-tier-icon{background:#e8ddff}.achievement-group[data-tier="thu-thach"] .achievement-tier-icon{background:#fff0b8}.achievement-group[data-tier="cuc-kho"] .achievement-tier-icon{background:#ffd9b0}.achievement-group[data-tier="ac-mong"] .achievement-tier-icon{background:#ffc2c8}.achievement-group[data-tier="kiet-xuat"] .achievement-tier-icon{background:#f0c7e6}
.achievement-group[data-tier="huyen-thoai"] .achievement-tier-icon{background:linear-gradient(135deg,#4c1d95,#7c3aed,#2563eb,#06b6d4);background-size:250% 250%;animation:tierLegendary 5s ease infinite}
.achievement-group[data-tier="truyen-thuyet"] .achievement-tier-icon{background:linear-gradient(120deg,#7f1d1d,#dc2626,#f59e0b,#fde047,#a855f7,#2563eb,#06b6d4);background-size:500% 500%;animation:tierMythic 2.8s linear infinite;box-shadow:0 0 0 2px rgba(255,255,255,.7),0 0 26px rgba(220,38,38,.55)}
.achievement-group[data-tier="huyen-thoai"]>button{background-size:300% 300%!important;animation:tierLegendary 7s ease infinite}.achievement-group[data-tier="truyen-thuyet"]>button{background-size:500% 500%!important;animation:tierMythic 3.2s linear infinite}
@keyframes tierLegendary{0%{background-position:0% 50%}50%{background-position:100% 50%}100%{background-position:0% 50%}}
@keyframes tierMythic{0%{background-position:0% 50%;filter:saturate(1)}25%{background-position:100% 0%;filter:saturate(1.45)}50%{background-position:100% 100%;filter:saturate(1.8)}75%{background-position:0% 100%;filter:saturate(1.45)}100%{background-position:0% 50%;filter:saturate(1)}}

.achievement-tier-leaf{width:42px;height:42px;border-radius:50%;display:grid;place-items:center;font-size:24px}
</style>

<style>
.compare-collapse{margin:12px 0;border:1px solid var(--border,#d9e8d7);border-radius:16px;background:var(--card,#fff);overflow:hidden}
.compare-collapse>summary{cursor:pointer;list-style:none;padding:14px 16px;font-weight:800;display:flex;justify-content:space-between;align-items:center;gap:10px;background:linear-gradient(90deg,var(--pink),var(--green-light))}
.compare-collapse>summary::-webkit-details-marker{display:none}
.compare-collapse>summary::after{content:'⌄';font-size:18px;transition:transform .2s}
.compare-collapse:not([open])>summary::after{transform:rotate(-90deg)}
.compare-collapse .tablewrap{padding:0 12px 12px}
</style>

<style id="final-level-ranking-style">
.level-panel-final{margin:12px 0;padding:16px 18px;border:1px solid var(--line,#d9d9d9);border-radius:20px;background:linear-gradient(135deg,var(--card,#fff),var(--pink,#fce4ec));box-shadow:0 8px 24px rgba(0,0,0,.06)}
.level-panel-final .lv-top{display:flex;justify-content:space-between;align-items:center;gap:12px}
.level-panel-final .lv-title{font-size:12px;font-weight:800;opacity:.72;letter-spacing:.06em}
.level-panel-final .lv-number{font-size:30px;font-weight:950;line-height:1.1}
.level-panel-final .lv-xp{font-weight:900}
.level-panel-final .lv-bar{height:9px;border-radius:99px;background:rgba(120,120,120,.16);overflow:hidden;margin-top:12px}
.level-panel-final .lv-fill{height:100%;border-radius:99px;background:linear-gradient(90deg,var(--green,#7cb342),var(--pink,#ec407a))}
.level-panel-final .lv-next{font-size:12px;opacity:.72;margin-top:7px}
</style>

<style>.command-help{white-space:pre-wrap;padding:10px;border-radius:10px;background:#f8fafc;border:1px solid var(--line);font-size:12px;line-height:1.55}</style></head>
<body class="theme-vui">

<!-- 🔐 MÀN HÌNH XÁC THỰC -->
<div id="authScreen" style="display:none;">
  <div class="auth-box">
    <div style="font-size: 48px; margin-bottom: 10px;">🐝</div>
    <h2>🌷 Góc nhỏ của Ong</h2>
    <p>🔐 Đăng nhập bằng <b>tên + mật khẩu + mã</b>.</p>
    <div class="auth-inputs">
      <label>Tên</label>
      <input id="loginNameInput" autocomplete="username" placeholder="Ví dụ: Nguyễn Văn A">
      <label>Mật khẩu</label>
      <div style="position:relative"><input id="loginPasswordInput" type="password" autocomplete="current-password" placeholder="Nhập mật khẩu"><label style="display:flex;align-items:center;gap:7px;margin-top:6px;cursor:pointer"><input id="showLoginPassword" type="checkbox" style="width:18px" onchange="togglePasswordVisibility()"> 👁️ Xem mật khẩu</label></div>
      <label id="loginCodeLabel">Mã thành viên hoặc mã quản trị viên</label>
      <input id="loginCodeInput" type="text" inputmode="text" autocomplete="off" placeholder="Nhập mã được cấp">
      <small style="display:block;color:var(--muted);margin-top:-6px;">🔐 Nhập đúng mã và mật khẩu để vào.</small>
    </div>
    <div style="display:flex;flex-direction:column;gap:10px;">
      <button class="btn" onclick="handleLoginSubmit()">🔐 Đăng nhập</button>
      <button class="btn light" onclick="handleGuestLogin()">👤 Tiếp tục với tư cách khách</button>
    </div>
  </div>
</div>
...
<header><div class="top">
  <div class="brand">
    <div class="bee" id="beeLogo" title="Góc nhỏ của Ong">🐝</div>
    <div>
      <h1>🌷 Góc nhỏ của Ong</h1>
      <small>Học tập • kế hoạch • thói quen • nhật ký</small>
      <span class="sponsor-tag">Lumi tài trợ</span>
    </div>
  </div>
  <nav id="nav"></nav>
</div></header>
...
<section id="home" class="view active">
  <div class="card" style="margin-bottom:18px">
    <h2>🌷 Tổng quan của Ong</h2>
    <p id="todayText"></p>
    <div class="actions" style="margin-top:12px">
      <button class="btn" data-go="study">▶ Bắt đầu học</button>
      <button class="btn" data-go="todo" style="background:var(--green)">📋 Kế hoạch hôm nay</button>
      <button class="btn light" data-go="habit">🍀 Thói quen tháng</button>
      <button class="btn" style="background:#7209b7" data-go="endday">🌙 Kết ngày</button>
    </div>
  </div>

  <!-- PHẦN CẢM XÚC TỨC THỜI (REAL-TIME EMOTION) - KHÔNG BỊ THU GỌN KHI BẤM ONG 🐝 -->
  <div class="card keep-visible" id="homeRealtimeMoodCard" style="margin-bottom:18px;border-color:var(--red);">
    <h2>🎨 Cảm xúc của bạn bây giờ</h2>
    <p class="muted">Chọn nhanh cảm xúc hiện tại để giao diện tự động đồng bộ bảng màu toàn trang web.</p>
    <div class="mood" id="homeRealtimeMoodButtons" style="margin-top:10px"></div>
    <div id="realtimeComfort" class="quote" style="display:none;margin-top:14px"><b>💬 Lời nhắn dành cho bạn</b><div id="realtimeComfortText" style="margin-top:6px"></div></div>
    <div class="guest-only-note" style="display:none;margin-top:12px;padding:10px 12px;border-radius:12px;background:var(--pink);border:1px solid var(--red);color:var(--ink);font-size:13px">👤 <b>Chế độ khách:</b> chỉ được xem giao diện và thử chuyển màu. Các công cụ, nhập liệu, lưu dữ liệu và lệnh tự động đều bị khóa.</div>
    
  </div>

  <!-- NẠP LẠI LÝ TRÍ & KHOẢNH KHẮC - KHÔNG BỊ THU GỌN KHI BẤM ONG 🐝 -->
  <div class="card keep-visible" id="homeMomentsReasonCard" style="margin-bottom:18px;background:linear-gradient(135deg,var(--pink),var(--green-light));border-color:var(--red);">
    <h2>✨ Khoảnh khắc đáng nhớ & Nạp lại lý trí</h2>
    <p class="muted">Cảm thấy nản chí? Bấm vào nút bên dưới để bùng nổ một khoảnh khắc tuyệt vời và nạp đầy năng lượng!</p>
    <button class="btn" style="background:var(--red);" onclick="popRandomMoment()">🌟 Bùng nổ Khoảnh khắc đáng nhớ</button>
    <div id="popMomentBox" style="margin-top:12px;font-style:italic;font-weight:600;color:var(--red);"></div>
  </div>

  <!-- TỔNG QUAN CHỈ SỐ MỤC TIÊU HÔM NAY - KHÔNG BỊ THU GỌN KHI BẤM ONG 🐝 -->
  <div class="card keep-visible" id="homeProgressSummaryCard" style="margin-bottom:18px">
    <h2>📊 Tổng quan chỉ số & Mục tiêu hôm nay</h2>
    <div class="grid g4" id="homeProgressSummary" style="margin-top:10px"></div>
  </div>

  <!-- CHỈ SỐ HIỆN TẠI - KHÔNG BỊ THU GỌN KHI BẤM ONG 🐝 -->
  <div class="grid g4 keep-visible" id="homeStats"></div>

  <div class="card" style="margin-top:18px;background:linear-gradient(135deg,var(--pink),var(--green-light));border-color:var(--red)">
    <h2>💪 Khi thấy nản, làm một việc nhỏ</h2>
    <p class="muted">Một gợi ý ngắn hoặc thử thách nhỏ để bạn lấy lại động lực và bắt đầu ngay.</p>
    <div id="motivationBox" class="quote" style="margin-bottom:12px">✨ Bấm nút bên dưới để nhận một việc nhỏ tạo đà.</div>
    <button class="btn sm" onclick="loadMotivation()">🚀 Tạo động lực cho mình</button>
  </div>
  <div class="grid g2" style="margin-top:18px">
    <div class="card"><h2>📝 Việc hôm nay</h2><div id="todayTodos"></div></div>
    <div class="card"><h3>📅 Lịch hôm nay</h3><div id="todaySchedule"></div></div>
  </div>
  <div class="grid g3" style="margin-top:18px">
    <div class="card" style="display:none" aria-hidden="true">
      <div id="homeMood"></div><div id="homeMotivationBox"></div>
    </div>
    <div class="card">
      <h3>🔥 Chuỗi ngày liên tiếp</h3>
      <div id="streak"></div>
    </div>
    <div class="card"><h2>🌱 Tổng hợp hoàn thành</h2><div id="overallCompletionSummary"></div></div>
  </div>
</section>
...
<section id="admin" class="view">
  <div class="card">
    <h2>👑 QUẢN TRỊ HỆ THỐNG & THÀNH VIÊN</h2>
    <p class="muted">Khu vực dành riêng cho Quản trị viên và Người sáng lập web để cấp mã, nâng/hạ cấp và quản lý tài khoản.</p>
    <div class="card" style="margin-top:16px;background:var(--pink);border-color:var(--red);">
      <h3>🎟️ Cấp mã thành viên</h3>
      <p class="muted">Nhập <b>tên thành viên + mã thành viên mong muốn</b>. Không cần nhập mật khẩu tại đây. Mỗi mã chỉ gắn với đúng một tài khoản và thành viên có thể chọn mã dễ nhớ.</p>
      <button class="btn" onclick="adminIssueMemberCode()">✨ Cấp mã thành viên mới</button>
    </div>
    <div id="adminRoleManagementCard" class="card founder-only-admin-card" style="margin-top:16px;background:linear-gradient(135deg,#fffbe8,#eef8ff);border-color:#d8b24c;">
      <h3>🛡️ Nâng cấp / hạ cấp tài khoản</h3>
      <p class="muted">Nhập mã vai trò để thay đổi cấp tài khoản. <b>111 = Người sáng lập web</b> · <b>999 = Quản trị viên</b>. Chỉ Người sáng lập mới có thể cấp/hạ cấp Người sáng lập; Quản trị viên có thể nâng cấp thành viên lên Quản trị viên và hạ cấp Quản trị viên.</p>
      <div class="form" style="margin-top:10px">
        <div><label>👤 Tên tài khoản</label><input id="roleTargetName" placeholder="Tên tài khoản cần nâng/hạ cấp"></div>
        <div><label>🔢 Mã vai trò</label><input id="roleTargetCode" placeholder="111 hoặc 999" inputmode="numeric"></div>
      </div>
      <button class="btn sm" style="margin-top:10px" onclick="adminChangeRoleByCode()">🔐 Áp dụng mã vai trò</button>
      <div class="muted" style="margin-top:8px">🔒 Không thể xóa hoặc hạ cấp Người sáng lập bằng quyền Quản trị viên.</div>
    </div>
    <div class="card founder-only-admin-card" style="margin-top:16px;background:linear-gradient(135deg,#f3fff7,#f4f0ff);border-color:#78b98b;">
      <h3>🎨 Xưởng tạo Role — CHỈ NGƯỜI SÁNG LẬP</h3>
      <p class="muted">Tạo bao nhiêu role tùy thích, đặt tên + biểu tượng + màu. Có thể dùng 1 màu hoặc chuyển màu, rồi gán role đó cho từng thành viên.</p>
      <button class="btn sm" onclick="founderCreateRole()">✨ Tạo role mới</button>
      <div id="customRolesList" style="margin-top:12px"></div>
    </div>
    <div class="card" style="margin-top:16px;background:linear-gradient(135deg,#fff8fb,#f3fff7);border-color:var(--red);">
      <h3>💌 Lời động viên theo hạng</h3>
      <p class="muted">Chỉ Quản trị viên nhìn thấy khu vực này. Thành viên chỉ nhìn thấy lời động viên tương ứng với hạng của mình trong bảng so sánh.</p>
      <div class="form" style="margin-top:10px">
        <div><label>🏆 Hạng</label><select id="adminMotivationRank"><option value="🥇 Hạng 1">🥇 Hạng 1</option><option value="🥈 Hạng 2">🥈 Hạng 2</option><option value="🥉 Hạng 3">🥉 Hạng 3</option><option value="🌱 Đang tiến bộ">🌱 Đang tiến bộ</option></select></div>
        <div class="full"><label>💬 Lời động viên</label><textarea id="adminMotivationText" placeholder="Ví dụ: Bạn đang làm rất tốt, tiếp tục giữ nhịp nhé! 🐝🍀"></textarea></div>
      </div>
      <button class="btn sm" style="margin-top:10px" onclick="adminAddMotivation()">💌 Thêm lời động viên</button><div class="muted" style="margin-top:8px">🔐 Cú pháp Admin: <code>MOTIVATION|Hạng 1|Lời động viên</code>. Một hạng có thể có nhiều lời.</div>
      <div id="adminMotivationList" style="margin-top:12px"></div>
    </div>
    <div style="margin-top:16px;" id="adminMemberListContainer" class="founder-only-admin-card"></div>
  </div>
</section>
...
<section id="profile" class="view">
  <div class="card" style="max-width: 600px; margin: auto;">
    <h2>👤 THÔNG TIN TÀI KHOẢN (PROFILE)</h2>
    <p class="muted">Quản lý thông tin cá nhân và phiên đăng nhập của bạn.</p>
    
    <div style="margin-top: 20px; background: var(--pink); padding: 20px; border-radius: 16px; border: 1px solid var(--red);">
      <p><b>👤 Tên thành viên:</b> <span id="profileDisplayName" style="font-size: 18px; color: var(--red);"></span></p>
      <p><b>🔑 Loại tài khoản:</b> <span id="profileRoleBadge" class="tag red"></span></p>
    </div>

    <div style="margin-top:18px;background:var(--card);padding:16px;border:1px solid var(--line);border-radius:16px">
      <h3 style="margin-top:0;color:var(--red)">🏅 Huy hiệu & 🎭 Role</h3>
      <p class="muted">Huy hiệu và Role là hai phần riêng biệt. Bạn có thể có nhiều Role và nhiều Huy hiệu; từng Huy hiệu có thể bật Công khai hoặc để Riêng tư.</p>
      <div id="profileAchievementBadges" style="display:flex;gap:7px;flex-wrap:wrap;margin:10px 0"></div>
      <div id="profileZoneBadges" style="display:flex;gap:7px;flex-wrap:wrap;margin:10px 0"></div>
      <div id="profileBadgePrivacy" style="display:grid;gap:7px"></div>
    </div>

    <div style="margin-top: 20px;">
      <h3 style="color: var(--red);">✏️ Đổi tên thành viên</h3>
      <div class="form" style="margin-top: 8px;">
        <div class="full"><input id="editProfileNameInput" placeholder="Nhập tên mới..."></div>
      </div>
      <button class="btn sm" style="margin-top: 10px;" onclick="saveProfileName()">💾 Lưu tên mới</button>
    </div>

    <div style="margin-top: 24px; border-top: 1px solid var(--line); padding-top: 20px;">
      <h3 style="color: var(--red);">🔑 Đổi mật khẩu</h3>
      <p class="muted" style="font-size:13px">Bạn có thể đổi mật khẩu. Hãy tự ghi nhớ mật khẩu mới; nhóm không hỗ trợ cấp lại.</p>
      <div class="form" style="margin-top:8px">
        <div class="full"><input id="currentPasswordInput" type="password" placeholder="Mật khẩu hiện tại"></div>
        <div><input id="newPasswordInput" type="password" placeholder="Mật khẩu mới"></div>
        <div><input id="confirmPasswordInput" type="password" placeholder="Nhập lại mật khẩu mới"></div>
      </div>
      <label style="margin-top:8px;display:flex;align-items:center;gap:8px;cursor:pointer"><input id="showPasswordInputs" type="checkbox" style="width:18px"> 👁️ Hiện mật khẩu</label>
      <button class="btn sm" style="margin-top:10px;" onclick="changeProfilePassword()">🔐 Đổi mật khẩu</button>
    </div>



    <div style="margin-top: 30px; border-top: 1px solid var(--line); padding-top: 20px; display: flex; gap: 10px;">
...
<!-- 2. END OF DAY -->
<section id="endday" class="view">
  <div class="card">
    <h2>🌙 Kết ngày</h2>
    <p class="muted">Nhìn lại một ngày trọn vẹn, ghi nhận lòng biết ơn và chuẩn bị năng lượng cho ngày mới 🌷.</p>
    <div class="form" style="margin-top:14px">
      <div class="full"><label>🙏 Điều biết ơn hôm nay</label><textarea id="endGratitude" placeholder="Hôm nay mình biết ơn vì điều gì..."></textarea></div>
      <div class="full"><label>📖 Bài học được học hôm nay</label><textarea id="endLesson" placeholder="Hôm nay mình rút ra bài học gì..."></textarea></div>
      <div class="full"><label>✨ Ngày mai điều quan trọng nhất là gì</label><input id="endTomorrow" placeholder="Ví dụ: Hoàn thành đề cương Lý..."></div>
      <div class="full"><label>💗 Cảm xúc hôm nay (Đồng bộ tự động từ mục Cảm xúc)</label><input id="endMoodDisplay" readonly style="background:var(--pink);font-weight:700"></div>
    </div>
    <button class="btn" style="margin-top:14px" onclick="saveEndDaySnapshot()">💾 Lưu & Đóng ngày</button>
  </div>
  <div class="card" style="margin-top:18px">
    <h2>📚 Lịch sử kết ngày</h2>
    <div id="endDayHistory"></div>
  </div>

  <button class="btn light command-toggle" data-command-panel="enddayCommandPanel" style="margin-top:14px">🤖 Nhập lệnh tự động</button>
  <div id="enddayCommandPanel" class="card command-panel" style="margin-top:12px;display:none">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán câu lệnh AI vào đây để tự điền kết ngày.</p>
    <textarea id="enddayCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
ENDDAY|2026-08-10|Điều biết ơn|Bài học|Việc quan trọng ngày mai"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="enddayCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>
...
<section id="todo" class="view">
  <div class="card">
    <h2>📋 Kế hoạch theo ngày</h2>
    <p class="muted">Mỗi ngày là một danh sách riêng. Hoàn thành việc để nhận XP và tích lũy động lực! ⚡</p>
    <div class="form">
      <div><label>Ngày</label><input id="todoDate" type="date"></div>
      <div><label>Ưu tiên</label><select id="todoPriority"><option value="cao">Cao</option><option value="trung">Trung bình</option><option value="thap">Thấp</option></select></div>
      <div class="full"><label>Nội dung công việc</label><input id="todoTitle" placeholder="Ví dụ: Làm 30 câu Lý..."></div>
      <div><label>Giờ bắt đầu (tuỳ chọn)</label><input id="todoTime" type="time"></div>
      <div><label>Ghi chú</label><input id="todoNote" placeholder="Ghi chú thêm"></div>
    </div>
    <div class="actions" style="margin-top:10px">
      <button class="btn" id="addTodo">+ Thêm việc</button>
      <button class="btn light" id="todoCommandBtn">🤖 Nhập lệnh tự động</button>
    </div>
    <div id="todoCommandPanel" class="card" style="margin-top:12px;display:none;background:linear-gradient(135deg,#f7fff9,#f5fbff);">
      <h3 style="margin-top:0">🤖 Nhập lệnh tự động</h3>
      <p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán lệnh AI vào ô dưới đây rồi nhấn ▶ Chạy lệnh. Ví dụ: <code>TODO|2026-08-11|Làm bài Toán|cao|19:00|Ôn chương 1</code></p>
      <textarea id="todoCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
TODO|2026-08-10|Làm 20 câu Lý|cao|19:00|Ôn chương 1"></textarea>
      <div class="actions" style="margin-top:10px">
        <button class="btn" id="runTodoCommand">▶ Chạy lệnh</button>
        <button class="btn light command-help-inline">❔ Thêm cú pháp</button>
      </div>
    </div>
  </div>
  <div class="card" style="margin-top:18px">
    <div class="actions" style="justify-content:space-between">
      ...
      <input id="todoSearch" style="max-width:260px" placeholder="🔎 Tìm việc...">
    </div>
    <div id="todoList"></div>
  </div>
</section>
...
<section id="study" class="view">
  <div class="grid g3">
    <div class="card">
      <h2>⏱️ Học tập, Thời gian & Pomodoro</h2><p class="muted">Pomodoro chỉ dùng để hỗ trợ tập trung; không cộng XP. XP học tập được cập nhật bằng lệnh <b>STUDY_TIME</b>.</p>
      <div class="actions" style="margin-bottom:12px">
        <button class="btn sm light" onclick="applyPomoPreset(25,5,15,4)">⏱️ 25/5 (Nghỉ dài sau 4 vòng)</button>
        <button class="btn sm light" onclick="applyPomoPreset(50,10,20,4)">⏱️ 50/10 (Nghỉ dài sau 4 vòng)</button>
      </div>
      <div class="clock" id="studyClock">00:00:00</div>
      <div class="form" style="margin-bottom:10px">
        <div><label>Tập trung (phút)</label><input id="pomoFocusInput" type="number" step="0.1" value="25" onchange="updatePomoSettings()"></div>
        <div><label>Nghỉ ngắn (phút)</label><input id="pomoShortInput" type="number" step="0.1" value="5" onchange="updatePomoSettings()"></div>
        <div><label>Nghỉ dài (phút)</label><input id="pomoLongInput" type="number" step="0.1" value="15" onchange="updatePomoSettings()"></div>
      </div>
      <div style="margin-bottom:10px;display:flex;align-items:center;gap:8px;">
        <input id="pomoSoundCheck" type="checkbox" checked onchange="updatePomoSettings()" style="width:18px;height:18px;">
        <label for="pomoSoundCheck" style="margin:0;cursor:pointer;color:var(--ink);font-weight:600;">🔊 Bật âm báo khi hết giờ</label>
      </div>
      <select id="studySubject" style="margin-bottom:10px"><option value="">Chọn môn</option><option>Toán</option><option>Lý</option><option>Hóa</option><option>Văn</option><option>Anh</option><option>Khác</option></select>
      <div class="mode" style="margin-bottom:10px">
        <button data-mode="focus" class="active">Tập trung</button>
        <button data-mode="short">Nghỉ ngắn</button>
        <button data-mode="long">Nghỉ dài</button>
      </div>
      <div class="actions">
        <button class="btn" id="studyStart">Bắt đầu</button>
        <button class="btn gray" id="studyPause">Tạm dừng</button>
        <button class="btn danger" id="studyStop">Dừng & lưu phiên</button>
      </div>
      <p class="kpi" id="studyState" style="margin-top:10px">Chưa bắt đầu phiên học.</p>
    </div>
    <div class="card">
      <h2>🎯 Mục tiêu thời gian học tập</h2>
      <div class="form">
        <div><label>Hôm nay (phút)</label><input id="goalDay" type="number" min="0"></div>
        <div><label>Tuần này (phút)</label><input id="goalWeek" type="number" min="0"></div>
        <div><label>Tháng này (phút)</label><input id="goalMonth" type="number" min="0"></div>
      </div>
      <button class="btn" id="saveGoals" style="margin-top:10px">Lưu mục tiêu</button>
    </div>
    <div class="card"><h2>📚 Phiên học gần đây</h2><div class="muted">Hiển thị theo ngày; tất cả Thành viên, Quản trị viên và Người sáng lập đều có thể xem.</div><div id="studySessions"></div></div>
  </div>
  <div class="card founder-study-only" style="margin-top:18px">
    <h2>📊 Thời gian học theo môn</h2>
    <div id="subjectStats"></div>
  </div>

  <button class="btn light command-toggle admin-only-command" data-command-panel="studyCommandPanel" style="margin-top:14px">🤖 Nhập lệnh thời gian học chính thức 🔒 ADMIN/FOUNDER</button>
  <div id="studyCommandPanel" class="card command-panel admin-only-command" style="margin-top:12px;display:none">
    <h3>🤖 Nhập lệnh thời gian học chính thức 🔒 ADMIN/FOUNDER</h3><p class="muted">Chỉ Quản trị viên và Người sáng lập mới thấy khu vực này. Đây là nơi nhập thời gian học chính thức; không liên quan Pomodoro và không dùng lệnh Nhật ký.</p>
    <textarea id="studyCommandBox" class="command" placeholder="Dán lệnh Admin vào đây...
STUDY_TIME|Tên tài khoản|Số phút (+/-)|Ngày (tùy chọn)
Ví dụ: STUDY_TIME|Nguyễn A|90|2026-08-10
Muốn trừ thời gian: STUDY_TIME|Nguyễn A|-30|2026-08-10"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="studyCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>

<!-- 5. ACHIEVEMENTS & QUESTS (RENOVATED ACHIEVEMENT SYSTEM) -->
<div id="achievementLevel" data-final-level-panel></div>
<section id="achievements" class="view">
  <div class="card">
    <h2>🏆 Hệ thống Thành tích & Nhiệm vụ</h2>
    <p class="muted">Khám phá các mốc thành tựu phân theo cấp độ khó, hoàn thành nhiệm vụ và tích lũy điểm kinh nghiệm 🍀.</p>
    <div class="grid g4" id="achievementSummaryStats" style="margin-top:14px"></div>
  </div>

  <!-- NHIỆM VỤ HỆ THỐNG: tự động tạo theo ngày, không cần Admin nhập lệnh -->
  <!-- BẢNG NHIỆM VỤ -->
  <div class="card" style="margin-top:18px">
    <h2>🎯 Bảng nhiệm vụ nhận XP</h2>
    <div id="questBoard"></div>
  </div>

  <!-- KHO THÀNH TÍCH MỚI (CHIA NHÓM, THU GỌN ĐỘC LẬP, PHÂN CẤP) -->
  <div class="card" style="margin-top:18px">
    <h2>🏆 Kho thành tích (Phân cấp & Nhóm độc lập)</h2>
    <p class="muted">Nhấn vào tiêu đề từng nhóm để Thu gọn / Mở rộng độc lập.</p>
    <div id="rebuiltAchievementGroups" style="margin-top:14px; display:flex; flex-direction:column; gap:16px;"></div>
  </div>
</section>

<!-- 6. HABITS -->
<section id="habit" class="view">
 <div class="card">
  <div class="monthnav">
    <div>
      <h2 style="margin:0">🍀 Thói quen theo tháng</h2>
      <span class="muted">Mỗi tháng một bộ thói quen xanh mướt. Duy trì đều đặn không phụ thuộc chuỗi học.</span>
    </div>
    <div class="actions">
      <button class="btn light" id="prevMonth">‹</button>
      <input id="habitMonth" type="month" style="width:145px">
      <button class="btn light" id="nextMonth">›</button>
    </div>
  </div>
  <div class="form">
    <div><label>Tên thói quen</label><input id="habitName" placeholder="Ví dụ: Dậy sớm học bài..."></div>
    <div><label>Mục tiêu tháng (số ngày)</label><input id="habitTarget" type="number" min="1" max="31" value="20"></div>
  </div>
  <div class="actions" style="margin-top:10px">
    <button class="btn" id="addHabit">+ Thêm thói quen</button>
    <button class="btn light" id="habitCommandBtn">🤖 Nhập lệnh tự động</button>
    <button class="btn light" id="reviewHabit">🔎 Review tháng</button>
  </div>
 </div>
 <div class="card" style="margin-top:18px"><div class="habit-grid" id="habitGrid"></div></div>
 <div class="grid g2" style="margin-top:18px">
   <div class="card"><h3>📈 Tổng quan tháng</h3><div id="habitMonthStats"></div></div>
   <div class="card"><h3>💾 Lưu & xem lại</h3><div id="habitArchive"></div></div>
 </div>

  <div id="habitCommandPanel" class="card command-panel" style="margin-top:18px;display:none">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán câu lệnh AI vào đây để thêm thói quen.</p>
    <textarea id="habitCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
HABIT|2026-08|Đọc sách|20"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="habitCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>

<!-- 7. MOOD -->
<section id="mood" class="view">
 <div class="card">
  <h2>💗 Hôm nay bạn cảm thấy thế nào?</h2>
  <p class="muted">Chọn trạng thái cảm xúc để Lumi gửi lời nhắn an ủi trực tiếp ngay lập tức!</p>
  <div class="mood" id="moodButtons" style="margin-top:12px"></div>
  <div style="margin-top:16px">
    <label>Ghi chú cảm xúc (tuỳ chọn)</label>
    <textarea id="moodNote" placeholder="Hôm nay mình cảm thấy..."></textarea>
  </div>
  <button class="btn" id="saveMood" style="margin-top:10px">Lưu cảm xúc hôm nay</button>
 </div>
 <div class="card" style="margin-top:18px">
  <h2>🌱 Lời nhắn an ủi từ Lumi</h2>
  <div id="comfort" class="quote" style="display:none"></div>
 </div>
 <div class="card" style="margin-top:18px;display:none !important">
  <h3>✏️ Kho lưu trữ lời nhắn an ủi & Trạng thái cảm xúc (Quản trị Admin)</h3>
  <details style="margin-top:10px">
    <summary style="cursor:pointer;font-weight:600;color:var(--red)">Bấm để mở rộng thêm trạng thái & lời nhắn tùy chỉnh (Chỉ dành cho Admin)</summary>
    
    <!-- KHU VỰC THÊM TRẠNG THÁI CẢM XÚC MỚI -->
    <div style="margin-top:12px;background:var(--pink);padding:14px;border-radius:12px;border:1px solid var(--red)">
      <h4 style="margin:0 0 8px;color:var(--red)">✨ [ADMIN] Thêm trạng thái cảm xúc bằng khuôn mặt</h4>
      <div class="form">
        <div><label>Biểu tượng khuôn mặt (Face Emoji)</label><input id="newMoodIcon" value="😔"></div>
        <div><label>Tên trạng thái</label><input id="newMoodName" placeholder="Ví dụ: Buồn, Vui, Mệt mỏi..."></div>
      </div>
      <button class="btn sm" style="margin-top:8px" onclick="addNewMoodDef()">+ Thêm trạng thái cảm xúc (Admin)</button>
    </div>

    <div class="form" style="margin-top:14px">
      <div><label>Chọn trạng thái áp dụng</label><select id="customComfortMood"></select></div>
      <div class="full"><label>Nội dung lời nhắn an ủi / động viên mới</label><input id="customComfortText" placeholder="Nhập câu nói an ủi của bạn..."></div>
    </div>
    <button class="btn sm" style="margin-top:10px" onclick="addCustomComfort()">Thêm vào kho Lumi (Admin)</button>
 ...
 <div class="card" style="margin-top:18px">
  ...
  <div class="card command-panel" style="margin-top:18px">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Lệnh tạo trạng thái/lời nhắn mới yêu cầu quyền Admin.</p>
    <textarea id="moodCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
MOOD_DEF|😔|Buồn
COMFORT|Buồn|Hãy nhẹ nhàng với bản thân nhé.
# Mã số 13 — lời nhắn chung cho toàn bộ thành viên, chỉ Admin/Founder:
COMFORT|Cảm xúc|Lời nhắn muốn gửi cho tất cả thành viên"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="moodCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>
...
<section id="schedule" class="view">
 <div class="card">
  <h2>🗓️ Lịch trình hàng tháng</h2>
  <p class="muted">Tự thêm, sửa đổi hoặc xóa lịch trình cá nhân.</p>
  <div class="form">
    <div><label>Ngày</label><input id="schDate" type="date"></div>
    <div><label>Giờ</label><input id="schTime" type="time"></div>
    <div><label>Tiêu đề</label><input id="schTitle" placeholder="Ví dụ: Học Lý..."></div>
    <div><label>Loại</label><select id="schType"><option>Học tập</option><option>Cá nhân</option><option>Nhóm</option><option>Khác</option></select></div>
  </div>
  <div class="actions" style="margin-top:10px">
    <button class="btn" id="addSchedule">+ Thêm lịch</button>
    <button class="btn light" id="scheduleCommandBtn">🤖 Nhập lệnh tự động</button>
  </div>
 </div>
 <div class="card" style="margin-top:18px"><div id="scheduleList"></div></div>

  <div id="scheduleCommandPanel" class="card command-panel" style="margin-top:18px;display:none">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán câu lệnh AI vào đây để thêm lịch.</p>
    <textarea id="scheduleCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
SCHEDULE|2026-08-10|20:00|Ôn bài|Học tập"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="scheduleCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>

<!-- 9. MOMENTS & TIMELINE — TÁCH RIÊNG -->
<section id="moments" class="view">
  <div class="card">
    <h2>📸 Khoảnh khắc đáng nhớ</h2>
    <p class="muted">Đây là nơi chỉ lưu những dấu mốc thật sự đáng nhớ: một nhiệm vụ lớn hoàn thành xuất sắc, một cột mốc quan trọng, một lần bạn làm được điều khiến chính mình tự hào. Nó KHÔNG phải dòng thời gian hoạt động.</p>
    <div class="form">
      <div><label>Ngày</label><input id="mDate" type="date"></div>
      <div><label>Tiêu đề khoảnh khắc</label><input id="mTitle" placeholder="Ví dụ: Hoàn thành một nhiệm vụ lớn xuất sắc..."></div>
      <div class="full"><label>Ghi chú chi tiết / Cảm xúc</label><textarea id="mDesc" placeholder="Điều gì khiến khoảnh khắc này đặc biệt? Bạn đã làm được gì?"></textarea></div>
    </div>
    <div class="actions" style="margin-top:10px">
      <button class="btn" id="addMoment">🌟 Lưu khoảnh khắc đáng nhớ</button>
      <button class="btn light" onclick="showModal('🤖 Nhập lệnh Khoảnh khắc','<textarea id=\'mCmd\' class=\'command\' placeholder=\'MOMENT|2026-08-10|Tiêu đề|Mô tả\'></textarea><button class=\'btn\' style=\'margin-top:10px\' onclick=\'parseMomentCommand($(\'mCmd\').value);closeModal()\'>Chạy lệnh</button>')">🤖 Nhập lệnh</button>
    </div>
  </div>

  <div class="card" style="margin-top:18px">
    <h2>🌟 Những khoảnh khắc đáng nhớ</h2>
    <div id="momentsList" style="margin-top:14px"></div>
  </div>

  <button class="btn light command-toggle" data-command-panel="momentsCommandPanel" style="margin-top:14px">🤖 Nhập lệnh tự động</button>
  <div id="momentsCommandPanel" class="card command-panel" style="margin-top:12px;display:none">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán câu lệnh AI vào đây để thêm khoảnh khắc đáng nhớ.</p>
    <textarea id="momentsCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
MOMENT|2026-08-10|Tên khoảnh khắc|Mô tả"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="momentsCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>
...
<section id="journal" class="view">
 <div class="card">
  ...
  <div class="form">
    <div><label>Ngày</label><input id="jDate" type="date"></div>
    <div><label>Môn</label><input id="jSubject" placeholder="Lý - Hóa"></div>
    <div><label>Thời gian học (phút)</label><input id="jMinutes" type="number" min="0"></div>
    <div><label>Đánh giá 1–10</label><input id="jScore" type="number" min="1" max="10" step=".1"></div>
    <div class="full"><label>Nội dung đã học</label><textarea id="jContent"></textarea></div>
    <div class="full"><label>Kiến thức mới</label><textarea id="jNew"></textarea></div>
  </div>
  <div class="actions" style="margin-top:10px">
    <button class="btn" id="addJournal">+ Lưu nhật ký</button>
    <button class="btn light command-toggle" data-command-panel="journalCommandPanel">🤖 Nhập lệnh tự động</button>
  </div>
 </div>
 <div class="card" style="margin-top:18px"><div id="journalList"></div></div>

  <div id="journalCommandPanel" class="card command-panel" style="margin-top:18px;display:none">
    <h3>🤖 Nhập lệnh tự động</h3><p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán câu lệnh AI vào đây để thêm nhật ký.</p>
    <textarea id="journalCommandBox" class="command" placeholder="Dán lệnh AI vào đây...
JOURNAL|2026-08-10|Toán|90|9|Nội dung|Kiến thức mới"></textarea>
    <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="journalCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
  </div>
</section>
...
<section id="summary" class="view">
 <div class="card">
  <h2>📊 Tổng quan tuần • tháng • năm & Động lực</h2>
  <div class="grid g4" id="summaryStats"></div>
 </div>
 <div class="grid g2" style="margin-top:18px">
   <div class="card"><h3>⏱️ 7 ngày gần nhất</h3><div class="bar" id="weekChart"></div></div>
   <div class="card"><h3>📚 Theo môn</h3><div id="subjectChart"></div></div>
 </div>
 <div class="grid g3" style="margin-top:18px">
   <div class="card"><h3>📅 Tỷ lệ theo tháng trong năm</h3><div id="yearPlan"></div></div>
   <div class="card"><h3>🗓️ Tỷ lệ theo thứ trong tuần</h3><div id="weekdayPlan"></div></div>
   <div class="card"><h3>🌿 Theo quý</h3><div id="quarterPlan"></div></div>
 </div>
 <div class="grid g2" style="margin-top:18px">
   <div class="card">
     <button class="btn light summary-achievements-toggle" data-summary-panel="summaryAchievementsPanel" style="width:100%;text-align:left">🏆 Tất cả thành tích ▾</button>
     <div id="summaryAchievementsPanel" style="display:none;margin-top:12px">
       <div id="summaryAchievementList" class="achievement-list"></div>
     </div>
   </div>
 </div>
</section>
...
<section id="compare" class="view">
  <div class="card">
    <h2>🏆 Bảng xếp hạng</h2>
    <p class="muted">Bảng xếp hạng công bằng theo 📋 Công việc, 🍀 Thói quen và ⏱️ Thời gian học. Ba bảng độc lập, không trộn chỉ số.</p>
    <div class="actions" style="margin:12px 0;flex-wrap:wrap">
      <button class="btn light compare-period-btn" data-period="day">📅 Ngày</button>
      <button class="btn light compare-period-btn" data-period="week">🗓️ Tuần</button>
      <button class="btn light compare-period-btn" data-period="month">📆 Tháng</button>
    </div>
    <div id="comparisonPeriodLabel" class="muted" style="margin-bottom:12px"></div>
...
<section id="data" class="view">
 <button class="btn light command-toggle" data-command-panel="dataCommandPanel" style="margin-bottom:12px">🤖 Nhập lệnh tự động & Sao lưu dữ liệu</button>
 <div id="dataCommandPanel" class="card command-panel" style="display:none">
  <h2>🤖 Nhập lệnh tự động & Sao lưu dữ liệu 🐝🍀</h2>
  <p class="muted">⚠️ <b>Phần này có cú pháp.</b> Dán lệnh AI vào ô dưới đây. Đây là bộ xử lý chung cho các mục trong web.</p>
  <textarea id="dataCommandBox" class="command" placeholder="Dán một hoặc nhiều câu lệnh AI vào đây...
TODO|2026-08-10|Làm 20 câu Lý|cao|19:00|
SCHEDULE|2026-08-10|20:00|Ôn bài|Học tập"></textarea>
  <div class="actions" style="margin-top:10px"><button class="btn" data-command-target="dataCommandBox">▶ Chạy lệnh</button><button class="btn light command-help-inline">❔ Thêm cú pháp</button></div>
 </div>
 <div class="card founder-only-admin-card" style="margin-top:18px;background:linear-gradient(135deg,#fff8e7,#eef4ff);border-color:#c7a34a;">
  <h2>⚡ Tạo Role nhanh — CHỈ NGƯỜI SÁNG LẬP</h2>
  <p class="muted"><b>Đây là biểu mẫu tạo Role mới, không phải lệnh.</b> Bạn chỉ cần điền các ô bên dưới; hệ thống sẽ lưu một Role mới vào Xưởng. Khu vực này không chọn tài khoản và không tự gán Role cho bất kỳ ai.</p>
  <div class="role-workshop-grid" style="margin-top:12px">
   <div><label>Tên Role</label><input id="dataRoleName" value="Người dẫn đường"><small class="muted">Tên sẽ xuất hiện trong capsule, hồ sơ và danh sách Role.</small></div>
   <div><label>Icon chính</label><input id="dataRoleIcon" value="🌟" maxlength="6"><small class="muted">Biểu tượng đại diện nằm trước tên Role.</small></div>
   <div><label>Màu nền 1</label><input id="dataRoleColor1" type="color" value="#312e81"><small class="muted">Màu chủ đạo của capsule.</small></div>
   <div><label>Màu nền 2</label><input id="dataRoleColor2" type="color" value="#06b6d4"><small class="muted">Màu phối thứ hai cho chuyển màu.</small></div>
   <div class="full"><label>Gradient nền</label><input id="dataRoleGradient" value="linear-gradient(135deg,#312e81,#06b6d4)"><small class="muted">Có thể dùng linear-gradient, radial-gradient hoặc conic-gradient. Đây là nền thực tế của Role.</small></div>
   <div><label>Phong cách</label><select id="dataRoleStyle"><option>Minimal</option><option>Cyber</option><option>Space</option><option>Nature</option><option>Energy</option><option>Dark</option><option>Light</option><option>Geometry</option><option>Cute Neutral</option><option>Mystery</option></select><small class="muted">Quy định cảm giác tổng thể, viền và cách trình bày.</small></div>
   <div><label>Animation</label><select id="dataRoleAnimation"><option value="none">Đứng yên</option><option value="glow">Glow</option><option value="pulse">Pulse</option><option value="sparkle">Sparkle</option><option value="orbit">Orbit</option><option value="shimmer">Shimmer</option><option value="wave">Wave</option><option value="bounce">Bounce</option><option value="particle">Particle</option><option value="bee-fly">Bee Fly</option><option value="heart-float">Heart Float</option><option value="triangle-orbit">Triangle Orbit</option><option value="star-orbit">Star Orbit</option><option value="energy-wave">Energy Wave</option></select><small class="muted">Quy định icon trang trí nhấp nháy, bay, quay hoặc chuyển động.</small></div>
   <div><label>Preset ánh sáng đặc biệt</label><select id="dataRoleLightPreset"><option value="none">Không dùng preset đặc biệt</option><optgroup label="🌌 Vô Cực"><option value="cosmic-float">Cosmic Float — icon trôi lơ lửng</option><option value="nebula-breathe">Nebula Breathe — nhịp thở tinh vân</option><option value="portal-drift">Portal Drift — trôi quanh cổng không gian</option></optgroup><optgroup label="🏛️ Thần Thoại"><option value="mythic-rune">Mythic Rune — rune phát sáng</option><option value="divine-aura">Divine Aura — hào quang thần thánh</option><option value="constellation-crown">Constellation Crown — chòm sao vương miện</option></optgroup></select><small class="muted">Chỉ điều khiển ánh sáng/chuyển động của icon; preset không đổi màu nền Gradient của Role.</small></div>
   <div><label>Tốc độ animation</label><input id="dataRoleSpeed" type="range" min=".8" max="20" step=".2" value="6"><small class="muted">Số giây càng nhỏ thì chuyển động càng nhanh.</small></div>
   <div><label>Độ mạnh hiệu ứng</label><input id="dataRoleStrength" type="range" min="0" max="3" step=".1" value="1"><small class="muted">Điều chỉnh độ sáng, glow và độ nổi.</small></div>
   <div><label>Kích thước Role</label><input id="dataRoleSize" type="range" min=".55" max="1.15" step=".05" value=".72"><small class="muted">Mặc định thu nhỏ Role để không che tên hoặc thành viên khác. Founder có thể đặt lại kích thước cho từng Role.</small></div>
   <div><label>Hướng chuyển động</label><select id="dataRoleDirection"><option value="clockwise">Theo chiều kim đồng hồ</option><option value="counter">Ngược chiều kim đồng hồ</option><option value="vertical">Lên xuống</option><option value="horizontal">Trái phải</option></select><small class="muted">Hướng áp dụng cho các animation có quỹ đạo.</small></div>
   <div><label><input id="dataRoleGlow" type="checkbox" checked style="width:18px"> Bật Glow</label><small class="muted">Tạo vùng sáng xung quanh capsule.</small></div>
   <div><label>Màu icon trang trí</label><input id="dataRoleDecorColor" type="color" value="#facc15"><small class="muted">Màu của các icon ở quanh Role.</small></div>
   <div><label>Nền icon trang trí</label><input id="dataRoleDecorBg" value="rgba(15,23,42,.78)"><small class="muted">Nền phía sau icon trang trí.</small></div>
   <div class="full"><label>Mô tả / nguồn Role</label><textarea id="dataRoleOrigin" placeholder="Ví dụ: Role tạo cho nhóm học tập bền bỉ..."></textarea><small class="muted">Giải thích lý do Role được tạo; nội dung này được lưu cùng Role.</small></div>
  </div>
  <div class="actions" style="margin-top:12px"><button class="btn" onclick="createRoleFromDataQuickForm()">✨ Tạo Role mới</button><button class="btn light" onclick="resetDataQuickRoleForm()">Đặt lại biểu mẫu</button></div>
  <details class="card role-quick-guide" style="margin-top:12px;background:rgba(255,255,255,.74);border-color:#d6b86a"><summary><b>📖 Giải thích chi tiết cách tạo Role nhanh</b><span class="muted"> — bấm để mở/thu gọn</span></summary><div style="margin-top:12px"><p><b>Mục đích.</b> Biểu mẫu này giúp Founder tạo một Role mới nhanh hơn Xưởng mà không cần viết cú pháp. Các giá trị bạn chọn sẽ được lưu trực tiếp vào cấu hình Role. Chức năng này chỉ tạo Role; nó không chọn tài khoản, không có tên tài khoản và không tự động gán Role cho bất kỳ thành viên nào.</p><p><b>Tên Role và Icon chính.</b> Tên là nhãn được hiển thị trong capsule, hồ sơ và danh sách Role. Icon chính là biểu tượng đứng trước tên. Hãy chọn tên ngắn, dễ đọc vì Role sẽ hiển thị ở cỡ nhỏ dưới tên thành viên.</p><p><b>Màu nền 1, Màu nền 2 và Gradient nền.</b> Hai ô màu là các màu dự phòng và màu phối. Ô Gradient nền là nền thực tế được Role sử dụng: <code>linear-gradient</code> tạo dải màu, <code>radial-gradient</code> tạo vùng sáng lan từ tâm, còn <code>conic-gradient</code> tạo vòng màu. Nếu muốn màu ổn định, hãy dùng một gradient đơn giản với hai màu gần nhau; tránh quá nhiều màu tương phản.</p><p><b>Phong cách.</b> Phong cách chỉ điều chỉnh cảm giác thị giác như viền, độ sáng và cách trình bày. Nó không tự thay đổi màu nền bạn đã nhập.</p><p><b>Animation.</b> Animation quyết định icon trang trí chuyển động thế nào. Chọn “Đứng yên” nếu muốn Role tĩnh; chọn Glow/Pulse cho nhịp sáng nhẹ; Orbit/Star Orbit cho chuyển động quanh capsule; Wave/Energy Wave cho chuyển động theo hướng; Sparkle/Particle cho điểm sáng. Animation không nên dùng quá nhiều icon hoặc tốc độ quá nhanh vì sẽ làm Role rối mắt.</p><p><b>Tốc độ và Độ mạnh.</b> Tốc độ tính theo giây; số càng nhỏ thì chạy càng nhanh. Độ mạnh từ 0 đến 3, ảnh hưởng độ sáng và glow. Mức khoảng 0.7–1.2 phù hợp Role thông thường; mức cao nên dành cho Role đặc biệt.</p><p><b>Kích thước Role.</b> Thanh này đặt kích thước ban đầu của capsule. Mức mặc định khoảng 0.72 giúp Role nhỏ, nằm gọn dưới tên và không che thành viên khác. Có thể tăng hoặc giảm trong khoảng cho phép; kích thước này không làm thay đổi màu hay nội dung Role.</p><p><b>Hướng chuyển động, Glow, màu/nền icon trang trí.</b> Hướng chỉ có tác dụng với animation có quỹ đạo. Glow bật vùng sáng quanh Role. Màu icon và nền icon quyết định các biểu tượng trang trí quanh capsule; nên chọn màu tương phản với nền để dễ nhìn.</p><p><b>Mô tả / nguồn Role.</b> Đây là phần ghi lại lý do tạo Role, ví dụ phần thưởng, nhóm học tập hoặc một cột mốc. Mô tả giúp Founder và thành viên hiểu nguồn gốc Role về sau.</p><p><b>Sau khi bấm “Tạo Role mới”.</b> Hệ thống kiểm tra quyền Founder, kiểm tra tên trùng, lưu Role vào Xưởng và làm mới danh sách. Role mới chưa được gán cho ai. Nếu muốn trao Role, Founder thực hiện riêng trong Xưởng bằng nút gán thủ công.</p></div></details>
 </div>
 <div class="card" style="margin-top:18px">
  <h2>💾 Sao lưu & khôi phục dữ liệu</h2>
  <p class="muted">Quản lý dữ liệu bằng file JSON.</p>
  <div class="actions" style="margin-top:10px">
    <button class="btn light" onclick="exportDataJSON()">📥 Xuất file Backup (JSON)</button><button class="btn light" onclick="exportWholeProjectStable()">📦 Xuất toàn bộ dự án (JSON)</button>
    <button class="btn light" onclick="importDataJSONPrompt()">📤 Nhập file Backup (JSON)</button>
    <button class="btn danger" id="resetAll">⚠️ Reset toàn bộ</button>
  </div>
 </div>
 <div class="card" style="margin-top:18px">
  <h2>📎 Dữ liệu Excel / Google Sheets</h2>
  <p class="muted">Quản lý các liên kết dữ liệu, thêm dòng mới bằng nút (+) và tự do chỉnh sửa tiêu đề cột.</p>
  <div id="sheetLinksContainer"></div>
  <button class="btn sm" style="margin-top:10px" onclick="addSheetLinkRow()">+ Thêm dòng link mới</button>
  <button class="btn sm light" style="margin-top:10px" onclick="saveSheetLinks()">Lưu tất cả link</button>
 </div>
...
<section id="trash" class="view">
 <div class="card">
  <h2>🗑️ Thùng rác phân tầng</h2>
  <p class="muted">Mỗi mục quản lý độc lập giúp bạn dễ dàng sao lưu, khôi phục hoặc xóa vĩnh viễn.</p>
  <div class="actions" style="margin:12px 0;flex-wrap:wrap;align-items:center">
   <button class="btn sm light" onclick="selectAllTrash(true)">☑️ Chọn tất cả</button>
   <button class="btn sm light" onclick="selectAllTrash(false)">⬜ Bỏ chọn tất cả</button>
   <button class="btn sm" onclick="restoreSelectedTrash()">↩️ Khôi phục mục đã chọn</button>
   <button class="btn danger sm" onclick="permanentDeleteSelectedTrash()">💀 Xóa vĩnh viễn mục đã chọn</button>
   <button class="btn danger sm" onclick="emptyTrashPermanently()">🗑️ Xóa vĩnh viễn toàn bộ thùng rác</button>
  </div>
...
<div class="modal" id="modal">
  <div class="modalbox">
    <div class="modalhead">
      <h2 id="modalTitle" style="margin:0;color:var(--red)"></h2>
      <button class="x" id="modalClose">×</button>
    </div>
    <div id="modalBody" style="margin-top:14px"></div>
  </div>
</div>
...
async function pullStateFromServer(){
  try{
    const url=SUPABASE_REST+'/'+SUPABASE_TABLE+
      '?id=eq.'+encodeURIComponent(SUPABASE_STATE_ID)+'&select=payload';
    ...
    if(!res.ok){
      console.warn('☁️ Supabase GET lỗi:',res.status,await res.text());
      return false;
    }

    const rows=await res.json();

    if(!Array.isArray(rows)||rows.length===0||!rows[0]||!rows[0].payload){
      if(Array.isArray(rows)&&rows.length===0){
        console.warn('☁️ Không tìm thấy dòng global_state.');
      }
      return false;
    }
    ...
    const localSessionAuth=state.sessionAuth;

    Object.keys(state).forEach(k=>{delete state[k];});
    Object.assign(state,cloudData);

    /* Phiên đăng nhập chỉ giữ trên thiết bị hiện tại. */
    state.sessionAuth=localSessionAuth;

    saveStateWithoutSession();

    console.log('☁️ Supabase: Đã tải dữ liệu.');
    return true;

  }catch(e){
    console.warn('☁️ Supabase: Lỗi tải dữ liệu.',e);
    return false;
  }
}
...
async function pushStateToServer(){
  try{
    const cloudData=JSON.parse(JSON.stringify(state));

    /* Không đưa phiên đăng nhập của thiết bị lên cloud. */
    delete cloudData.sessionAuth;
    ...
    if(!res.ok){
      ...
      console.warn('☁️ Supabase PATCH lỗi:',res.status,message);
      return false;
    }

    console.log('☁️ Supabase: Đã lưu dữ liệu.');
    return true;

  }catch(e){
    console.warn('☁️ Supabase: Lỗi lưu dữ liệu.',e);
    return false;
  }
}
...
async function createInitialSupabaseState(){
  try{
    ...
    const res=await fetch(SUPABASE_REST+'/'+SUPABASE_TABLE,{
      method:'POST',
      headers:supabaseHeaders({
        'Prefer':'return=minimal'
      }),
    ...
    if(!res.ok){
      console.warn('☁️ Supabase POST lỗi:',res.status,await res.text());
      return false;
    }

    console.log('☁️ Supabase: Đã tạo global_state.');
    return true;
  }catch(e){
    console.warn('☁️ Supabase: Lỗi tạo dữ liệu.',e);
    return false;
  }
}
...
function handleLoginSubmit(){
  ...
  if(code==='111'){
    ...
    setSessionAuth({name:founder.name,role:'Founder',code:'111',memberId:founder.id});
    switchUserData(state.sessionAuth); save(); checkAuthSession(); currentNavId='home'; menuCompact=false; go('home'); setTimeout(showPendingRoleNotifs,300);
    return;
  }
  ...
  if(code==='999'){
    ...
    setSessionAuth({name:admin.name,role:'Admin',code:'999',memberId:admin.id});
    switchUserData(state.sessionAuth); save(); checkAuthSession(); currentNavId='home'; menuCompact=false; go('home'); setTimeout(showPendingRoleNotifs,300);
    return;
  }
  ...
  setSessionAuth({name,role:'Member',code,memberId:account.memberId});
  switchUserData(state.sessionAuth); save(); checkAuthSession(); currentNavId='home'; menuCompact=false; go('home'); setTimeout(showPendingRoleNotifs,300);
}
...
function setupNavAndAdminRole(){
  ...
  const adminMotivationCard=document.querySelector("#admin .card[style*='gradient']"); if(adminMotivationCard) adminMotivationCard.style.display=(['Admin','Founder'].includes(role))?'':'none';
  applyGuestReadOnly();
  updateMenu();
}
...
function renderAdminView(){
  ...
  container.innerHTML=`<h3 style="color:var(--red);margin-bottom:12px;">🛡️ QUẢN LÝ TÀI KHOẢN & CẤP BẬC — CHỈ FOUNDER</h3>`+
...
function resetDataQuickRoleForm(){
  const vals={dataRoleName:'Người dẫn đường',dataRoleIcon:'🌟',dataRoleColor1:'#312e81',dataRoleColor2:'#06b6d4',dataRoleGradient:'linear-gradient(135deg,#312e81,#06b6d4)',dataRoleSpeed:'6',dataRoleStrength:'1',dataRoleDecorColor:'#facc15',dataRoleDecorBg:'rgba(15,23,42,.78)',dataRoleOrigin:''};
  Object.entries(vals).forEach(([id,v])=>{const el=$(id);if(el)el.value=v;});
  const style=$('dataRoleStyle'),anim=$('dataRoleAnimation'),dir=$('dataRoleDirection'),glow=$('dataRoleGlow');if(style)style.value='Minimal';if(anim)anim.value='none';if(dir)dir.value='clockwise';if(glow)glow.checked=true;
}
function createRoleFromDataQuickForm(){
  if(state.sessionAuth?.role!=='Founder')return alert('🔒 Chỉ Người sáng lập web mới được tạo Role.');
  const name=$('dataRoleName')?.value.trim()||'',icon=$('dataRoleIcon')?.value.trim()||'🏷️';
  if(!name)return alert('⚠️ Hãy nhập tên Role.');
  if((state.customRoles||[]).some(x=>String(x.name).toLocaleLowerCase('vi-VN')===name.toLocaleLowerCase('vi-VN')))return alert('🚨 Role này đã tồn tại.');
  const color1=$('dataRoleColor1')?.value||'#312e81',color2=$('dataRoleColor2')?.value||'#06b6d4';
  const role=roleSchema({id:uid(),name,icon,color1,color2,gradientCss:$('dataRoleGradient')?.value.trim()||`linear-gradient(135deg,${color1},${color2})`,gradient:true,sourceType:'custom',founderGift:true,origin:$('dataRoleOrigin')?.value.trim()||'Tạo từ biểu mẫu Tạo Role nhanh trong mục Dữ liệu',createdAt:new Date().toISOString(),effects:{animation:$('dataRoleAnimation')?.value||'none',style:$('dataRoleStyle')?.value||'Minimal',speed:Number($('dataRoleSpeed')?.value)||6,strength:Number($('dataRoleStrength')?.value)||1,count:8,size:Number($('dataRoleSize')?.value)||.72,direction:$('dataRoleDirection')?.value||'clockwise',lightPreset:$('dataRoleLightPreset')?.value||'none',gradient:true,glow:$('dataRoleGlow')?.checked!==false,cornerIcons:['✦','✧','✨','⭐'],cornerCount:4,decorColor:$('dataRoleDecorColor')?.value||'#facc15',decorBg:$('dataRoleDecorBg')?.value||'rgba(15,23,42,.78)'}});
  state.customRoles=Array.isArray(state.customRoles)?state.customRoles:[];state.customRoles.push(role);save();renderCustomRoles();renderAdminView();alert(`✅ Đã tạo Role ${role.icon} ${role.name}. Role chưa được gán cho tài khoản nào.`);resetDataQuickRoleForm();
}
...
function importDataJSONPrompt(){
  const jsonStr = prompt("Dán nội dung JSON backup vào đây để khôi phục:");
  if(!jsonStr) return;
  try {
    ...
    alert("Lỗi phân tích cú pháp JSON!");
  }
}
...
function recordActivity(type="task", customXP=0, detail=''){
...
function collectCurrentActivityDates(ownerId){
  ...
  scoped.sessions.forEach(x=>{if(x.date)dates.add(x.date)});
...
function recalculateCurrentProgress(ownerId,opts={}){
  ...
  const snapshot={...state,...scoped,xp:base.baseXP,studyMinutes,adminStudyTimes:getStudyRowsForOwner(ownerId),activityDates,activities:activityDates.length,bestStreak:streaks.best,streak:streaks.current,todos:scoped.todos,habits:scoped.habits};
...
let pomoTimer=null,pomoSec=25*60,pomoMode='focus',pomoRunning=false,pomoCount=0;
...
function startStudy(){
    if(!studyStartAt){studyStartAt=Date.now();studyElapsed=0;studyPaused=false;}
    ...
    if(!pomoRunning){
        ...
        pomoTimer=setInterval(()=>{
            ...
            if(pomoSec<=0){
                ...
                if(pomoMode==='focus'){
                    pomoCount++;
                    if(pomoCount%state.pomo.rounds===0) setPomoMode('long'); else setPomoMode('short');
...
function stopStudy(){
    ...
    if(sec>10){
        ...
        state.sessions.push({id:uid(),date:todayISO(),subject:$('studySubject').value||'Chưa chọn môn',minutes:mins,seconds:sec,createdAt:new Date().toISOString()});
        /* Pomodoro chỉ là bộ đếm/ghi phiên tham khảo; KHÔNG cộng XP. XP học tập do lệnh STUDY_TIME quản lý. */
    }
    studyStartAt=null; studyElapsed=0; studyPaused=false; setPomoMode('focus', true); save();
}
...
function toggleTodoDone(id, checked){
    ...
    edit('todos', id, {done: checked, completedAt: checked ? new Date().toISOString() : ''});

    if(todo.ownerId) updateAccountProgress('task_done',0,todo.ownerId,checked?1:-1);

    // 📋 Kế hoạch chỉ nhận +1 XP đúng lúc chuyển từ CHƯA HOÀN THÀNH → HOÀN THÀNH.
    // Không cộng lại khi render, reload hoặc bấm lại trạng thái đã hoàn thành.
    if(checked && !wasDone){
        recordActivity("task", 1, `Hoàn thành kế hoạch: ${todo.title}`);
    }

    // 🔗 ĐỒNG BỘ LẠI TOÀN BỘ CHUỖI KẾ HOẠCH → XP → CẤP ĐỘ → THÀNH TÍCH.
    // Không để state.xp / progress.xp và XP suy ra từ Kế hoạch chạy thành 2 nguồn khác nhau.
    const ownerId = accountOwnerId();
    if(ownerId){
    ...
    // Kiểm tra thành tích SAU khi XP + tiến độ đã được cập nhật.
    checkAchievements();

    // Lưu cả state cá nhân và progress của tài khoản đang đăng nhập.
    persistActiveUserData();
    save();
    renderTodos();
    renderPrivateXPHistoryAdmin();
    renderAchievementsView();
    try{finalRefreshLevelPanels();}catch(e){}
...
function editTodo(id){
    const x=state.todos.find(a=>a.id===id);if(!x)return;
    showModal('✏️ Sửa công việc',`<div class="form"><div class="full"><label>Nội dung</label><input id="mTitle" value="${esc(x.title)}"></div><div><label>Giờ</label><input id="mTime" type="time" value="${esc(x.time||'')}"></div><div><label>Ưu tiên</label><select id="mPri"><option value="cao">Cao</option><option value="trung">Trung bình</option><option value="thap">Thấp</option></select></div><div class="full"><label>Ghi chú</label><input id="mNote" value="${esc(x.note||'')}"></div></div><button class="btn" style="margin-top:10px" onclick="edit('todos','${id}',{title:$('mTitle').value,time:$('mTime').value,priority:$('mPri').value,note:$('mNote').value});closeModal()">Lưu</button>`);setTimeout(()=>$('mPri').value=x.priority,0)
}
          ...
          ${g.items.map(a=>{
            ...
            return `<button type="button" class="achievement ${unlocked?'':'locked'}" onclick="openAchievementDetail('${a.id}')" style="width:100%;text-align:left;cursor:pointer;border:1px solid ${g.accent||'var(--line)'};background:linear-gradient(135deg,${g.bg||'var(--card)'},#ffffff);border-radius:16px;padding:14px;display:flex;gap:12px;align-items:center">
              ...
              <div style="flex:1">
                ...
                ${special?'<div style="margin-top:5px;font-weight:800;color:var(--red)">✨ Nhấn để mở bất ngờ</div>':`<div style="margin-top:5px;font-weight:800;color:var(--red)">${unlocked?'🏆 Đã mở khóa':'🔒 Chưa mở khóa'} · ⚡ +${Number(a.xp)||0} XP</div>`}${(state.customAchievements||[]).some(c=>c.id===a.id)&&['Admin','Founder'].includes(state.sessionAuth?.role||'')?`<button type="button" class="btn danger sm" style="margin-top:7px" onclick="event.stopPropagation();deleteCustomAchievement('${a.id}')">🗑️ Xóa thành tích</button>`:''}
              </div>
            </button>`;
          }).join('')}
        </div>
...
function toggleHabit(id,day){
    ...
    if(h.ownerId) updateAccountProgress('habit_done',0,h.ownerId,h.days[day]?1:-1);
    const ownerId=h.ownerId||accountOwnerId();
    if(h.days[day]) awardDailyHabitMilestone(ownerId,currentHabitMonth,day);
    checkAchievements();
    save();
    renderHabits();
    renderComparison();
...
function renderAll(){
  try{renderPrivateXPHistoryAdmin();}catch(e){}
    ...
    // Kiểm tra lại thành tích khi mở/đổi module để dữ liệu đã làm trước đó cũng được tính.
    checkAchievements();
    checkAuthSession();
    updateFounderStudyVisibility();
    renderProfileView();
    renderAdminView();
    renderAdminMotivations();
    renderHome();
    renderTodos();
    renderHabits();
    renderMoods();
...
window.onload = async () => {
    /* ☁️ Lấy dữ liệu cloud trước khi render giao diện. */
    const cloudLoaded = await pullStateFromServer();
    if(!cloudLoaded){
      /*
        Nếu dòng global_state chưa tồn tại, tạo nó.
        Nếu đã tồn tại nhưng payload lỗi/rỗng, vẫn giữ dữ liệu local.
      */
      ...
      try{
        ...
        if(Array.isArray(checkRows)&&checkRows.length===0){
          await createInitialSupabaseState();
        }
      }catch(e){
...
<style id="themeRoleFixV15">
/* V15: icon bám sát capsule, không lệch khỏi viền */
.role-capsule{position:relative;overflow:visible;isolation:isolate}
.role-fx-layer{position:absolute;inset:0;pointer-events:none;overflow:visible;z-index:3}
.role-corner-placed{position:absolute!important;transform:translate(-50%,-50%)!important;background:transparent!important;border:0!important;box-shadow:none!important;width:20px!important;height:20px!important;padding:0!important;border-radius:0!important;line-height:20px!important;font-size:16px!important;filter:drop-shadow(0 0 3px rgba(255,255,255,.96)) drop-shadow(0 1px 2px rgba(15,23,42,.9))!important;z-index:5}
.role-corner-placed::before{display:none!important}
.role-corner-placed[style*="top:0%"]{margin-top:5px!important}
.role-corner-placed[style*="top:100%"]{margin-top:-5px!important}
.role-corner-placed[style*="left:0%"]{margin-left:5px!important}
.role-corner-placed[style*="left:100%"]{margin-left:-5px!important}
/* Đốm bạc và vệt sáng chéo cho hai nền */
/* Hiệu ứng bạc chỉ dành cho huy hiệu thành tích đã đạt; không phủ toàn bộ nhóm. */
.v3-ach-unlocked{position:relative;overflow:hidden;isolation:isolate}
.v3-ach-unlocked::before{content:"";position:absolute;inset:0;pointer-events:none;z-index:0;opacity:.7;background-image:radial-gradient(circle at 14% 25%,rgba(255,255,255,.95) 0 1.3px,transparent 2.7px),radial-gradient(circle at 64% 72%,rgba(214,236,255,.86) 0 1.1px,transparent 2.5px),radial-gradient(circle at 86% 28%,rgba(255,255,255,.9) 0 1.2px,transparent 2.6px);animation:silverDustV15 8s ease-in-out infinite alternate}
.v3-ach-unlocked::after{content:"";position:absolute;top:-80%;left:-35%;width:18%;height:260%;pointer-events:none;z-index:1;background:linear-gradient(90deg,transparent,rgba(255,255,255,.72),rgba(224,242,254,.32),transparent);transform:rotate(28deg);filter:blur(1px);animation:silverSlashV15 7.5s ease-in-out infinite}
.v3-ach-unlocked>*{position:relative;z-index:2}
.weekly-role-preview-v12{position:relative;overflow:hidden}
.weekly-role-preview-v12::before{content:"";position:absolute;inset:0;pointer-events:none;background-image:radial-gradient(circle at 15% 30%,rgba(255,255,255,.9) 0 1.5px,transparent 3px),radial-gradient(circle at 72% 68%,rgba(226,245,255,.75) 0 1.2px,transparent 3px);animation:silverDustV15 7s ease-in-out infinite alternate}
.weekly-role-preview-v12::after{content:"";position:absolute;top:-100%;left:-25%;width:14%;height:300%;pointer-events:none;background:linear-gradient(90deg,transparent,rgba(255,255,255,.75),transparent);transform:rotate(28deg);animation:silverSlashV15 7.5s ease-in-out infinite}
.weekly-role-preview-v12>*{position:relative;z-index:1}
@keyframes silverDustV15{from{opacity:.38;transform:translate3d(0,0,0)}to{opacity:.9;transform:translate3d(8px,-5px,0)}}
@keyframes silverSlashV15{0%,35%{left:-30%;opacity:0}48%{opacity:.9}68%,100%{left:125%;opacity:0}}
@media(max-width:600px){.role-corner-placed{width:17px!important;height:17px!important;font-size:14px!important}.achievement-group[data-tier="vo-cuc"]::before,.achievement-group[data-tier="than-thoai"]::before{opacity:.55;animation-duration:11s}.achievement-group[data-tier="vo-cuc"]::after,.achievement-group[data-tier="than-thoai"]::after{animation-duration:10s}}
@media(prefers-reduced-motion:reduce){.achievement-group[data-tier="vo-cuc"]::before,.achievement-group[data-tier="than-thoai"]::before,.achievement-group[data-tier="vo-cuc"]::after,.achievement-group[data-tier="than-thoai"]::after,.weekly-role-preview-v12::before,.weekly-role-preview-v12::after{animation:none!important}}
</style>
<script>
...
<style id="final-role-layout-motion">
/* Role thành viên: nhỏ, nằm ở dòng riêng bên dưới tên. */
.member-role-stack{display:flex!important;flex-wrap:wrap;gap:4px;margin:4px 0 0 0!important;max-width:100%;align-items:center}
.member-role-stack .role-capsule{min-width:0!important;min-height:24px!important;padding:3px 8px!important;font-size:11px!important;line-height:1.15!important;border-width:1px!important;--role-size:var(--member-role-scale)!important;transform:scale(var(--member-role-scale))!important;transform-origin:left center!important;box-shadow:0 2px 7px rgba(15,23,42,.16)!important}
.member-role-stack .role-corner-placed{width:14px!important;height:14px!important;font-size:11px!important;line-height:14px!important}
#profileRoleBadge>span{display:block!important}
#profileRoleBadge .member-role-stack{margin-top:5px!important}
/* Đóng băng màu nền của hai nhóm; chỉ cho icon chuyển động. */
/* Original preview effects restored below; no late freeze override. */
...
<style id="role-light-presets">
/* Preset ánh sáng chỉ tác động lên icon/lớp sáng; tuyệt đối không đổi màu nền Role. */
.role-light-cosmic-float .role-corner-placed{animation:lightCosmicFloat 6.8s ease-in-out infinite!important;filter:drop-shadow(0 0 5px rgba(186,230,253,.85))!important}
.role-light-nebula-breathe .role-corner-placed{animation:lightNebulaBreathe 5.4s ease-in-out infinite!important;filter:drop-shadow(0 0 7px rgba(196,181,253,.9))!important}
.role-light-portal-drift .role-corner-placed{animation:lightPortalDrift 8s linear infinite!important;filter:drop-shadow(0 0 5px rgba(125,211,252,.85))!important}
.role-light-mythic-rune .role-corner-placed{animation:lightMythicRune 3.8s ease-in-out infinite!important;filter:drop-shadow(0 0 6px rgba(253,230,138,.95))!important}
.role-light-divine-aura .role-corner-placed{animation:lightDivineAura 4.6s ease-in-out infinite!important;filter:drop-shadow(0 0 8px rgba(254,240,138,.95))!important}
.role-light-constellation-crown .role-corner-placed{animation:lightConstellation 7.2s ease-in-out infinite!important;filter:drop-shadow(0 0 6px rgba(216,180,254,.95))!important}
@keyframes lightCosmicFloat{0%,100%{transform:translate(-50%,-50%) translate(0,5px) rotate(-3deg);opacity:.72}50%{transform:translate(-50%,-50%) translate(6px,-8px) rotate(4deg);opacity:1}}
@keyframes lightNebulaBreathe{0%,100%{transform:translate(-50%,-50%) scale(.88);opacity:.62}50%{transform:translate(-50%,-50%) scale(1.12);opacity:1}}
@keyframes lightPortalDrift{0%{transform:translate(-50%,-50%) translate(0,3px) rotate(0)}50%{transform:translate(-50%,-50%) translate(8px,-4px) rotate(180deg)}100%{transform:translate(-50%,-50%) translate(0,3px) rotate(360deg)}}
@keyframes lightMythicRune{0%,100%{transform:translate(-50%,-50%) scale(.9) rotate(-8deg);opacity:.68}35%{transform:translate(-50%,-50%) scale(1.08) rotate(0);opacity:1}70%{transform:translate(-50%,-50%) scale(.96) rotate(8deg);opacity:.82}}
@keyframes lightDivineAura{0%,100%{transform:translate(-50%,-50%) scale(.86);opacity:.65}45%{transform:translate(-50%,-50%) scale(1.16);opacity:1}72%{transform:translate(-50%,-50%) scale(1);opacity:.86}}
@keyframes lightConstellation{0%,100%{transform:translate(-50%,-50%) translate(0,0) scale(.86);opacity:.7}25%{transform:translate(-50%,-50%) translate(3px,-6px) scale(1);opacity:1}50%{transform:translate(-50%,-50%) translate(7px,0) scale(.9);opacity:.8}75%{transform:translate(-50%,-50%) translate(3px,6px) scale(1.08);opacity:1}}
@media(prefers-reduced-motion:reduce){.role-light-cosmic-float .role-corner-placed,.role-light-nebula-breathe .role-corner-placed,.role-light-portal-drift .role-corner-placed,.role-light-mythic-rune .role-corner-placed,.role-light-divine-aura .role-corner-placed,.role-light-constellation-crown .role-corner-placed{animation:none!important}}
</style>

<style id="stable-rebuild-role-css">
.stable-origin-hero{padding:16px;border-radius:18px;border:2px solid #fbbf24;background:linear-gradient(135deg,#fff7ed,#fefce8,#ecfeff)}.stable-origin-name{font-size:24px;font-weight:900}.stable-origin-source{display:inline-flex;margin:9px 0;padding:7px 11px;border-radius:999px;background:#fef3c7;color:#92400e;border:1px solid #f59e0b;font-weight:900}.stable-origin-title{font-weight:1000;color:#9a3412}.stable-origin-section{margin-top:13px;padding:13px 15px;border-radius:15px;background:#f8fafc;border:1px solid #e2e8f0}.stable-origin-section h3{margin:0 0 8px}.stable-origin-section p{line-height:1.55;margin:6px 0}.stable-origin-swatches{display:flex;flex-wrap:wrap;gap:7px;margin:8px 0}.stable-origin-chip{display:inline-flex;align-items:center;gap:5px;padding:5px 8px;border-radius:999px;background:#fff;border:1px solid #cbd5e1;font-size:12px}.stable-origin-chip i{width:18px;height:18px;border-radius:50%;border:1px solid #94a3b8}.stable-role-click{cursor:pointer}.stable-edit-role{border-color:#f59e0b!important;color:#92400e!important}
#stableRoleEditor{position:fixed;inset:0;z-index:100000;background:rgba(15,23,42,.42);display:flex;align-items:center;justify-content:center;padding:18px}#stableRoleEditor>div{width:min(760px,96vw);max-height:92vh;overflow:auto;background:#fff;border-radius:20px;padding:18px}.stable-edit-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.stable-edit-grid label{display:flex;flex-direction:column;gap:4px;font-size:12px;font-weight:700}.stable-edit-grid input,.stable-edit-grid textarea{width:100%;box-sizing:border-box;padding:8px;border:1px solid #cbd5e1;border-radius:9px}.stable-edit-grid textarea{min-height:65px}.stable-wide{grid-column:1/-1}@media(max-width:650px){.stable-edit-grid{grid-template-columns:1fr}}
</style>
<script id="stable-rebuild-role-js">
(function(){'use strict';
...
<style id="study-ai-upgrade-css">
.study-ai-nav{display:flex;gap:6px;flex-wrap:wrap;margin-top:8px}.study-ai-nav button{font-size:12px}.study-ai-view{display:none}.study-ai-view.active{display:block}.study-ai-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.study-ai-box{background:linear-gradient(135deg,#f8fafc,#eff6ff);border:1px solid #bfdbfe;border-radius:18px;padding:15px}.study-ai-box h3{margin-top:0}.study-ai-box textarea,.study-ai-box input,.study-ai-box select{width:100%;box-sizing:border-box;border:1px solid #cbd5e1;border-radius:10px;padding:9px;margin:4px 0 8px}.study-ai-box textarea{min-height:130px}.study-ai-disclaimer{padding:10px 12px;background:#fff7ed;border:1px solid #fed7aa;border-radius:12px;color:#9a3412;margin:10px 0}.study-ai-card{padding:12px;border:1px solid #e2e8f0;border-radius:14px;background:#fff;margin:8px 0}.study-ai-card.correct{border-color:#22c55e;background:#f0fdf4}.study-ai-card.wrong{border-color:#fb7185;background:#fff1f2;animation:studyAiShake .3s}.study-ai-chip{display:inline-block;border-radius:999px;padding:5px 9px;background:#dbeafe;color:#1e40af;margin:2px;font-size:12px}.study-ai-reward{border-radius:16px;padding:14px;margin:8px 0;border:1px solid #fbbf24;background:linear-gradient(135deg,#fffbeb,#fef3c7)}.study-ai-reward.infinity{border-color:#a78bfa;background:linear-gradient(135deg,#eef2ff,#f5d0fe)}@keyframes studyAiShake{25%{transform:translateX(-4px)}75%{transform:translateX(4px)}}@keyframes studyAiConfettiFall{to{transform:translate(var(--dx),260px) rotate(360deg);opacity:0}}@media(max-width:700px){.study-ai-grid{grid-template-columns:1fr}}
</style>
<script id="study-ai-upgrade-js">
(function(){'use strict';
const key='studyEmpireAIStudioV1';const read=()=>{try{return JSON.parse(localStorage.getItem(key)||'{"flashcards":[],"exams":[],"feedback":[],"contributions":{"documents":0,"achievementPoints":0},"claimed":[] }')}catch(e){return {flashcards:[],exams:[],feedback:[],contributions:{documents:0,achievementPoints:0},claimed:[]}}};let data=read();const save=()=>localStorage.setItem(key,JSON.stringify(data));const esc=x=>String(x==null?'':x).replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));const $=id=>document.getElementById(id);const toast=m=>typeof showToast==='function'?showToast(m):alert(m);
...
function addNav(){const nav=$('nav');if(!nav||$('studyAiToolsNav'))return;const d=document.createElement('div');d.id='studyAiToolsNav';d.className='study-ai-nav';d.innerHTML='<button class="btn light" data-ai-view="flashcards">🧠 AI Flashcard</button><button class="btn light" data-ai-view="exam">📝 Chuyển File → Đề Thi</button>';nav.appendChild(d);d.querySelectorAll('[data-ai-view]').forEach(b=>b.onclick=()=>openView(b.dataset.aiView))}
function openView(which){document.querySelectorAll('.view').forEach(v=>v.classList.remove('active'));const el=$('studyAi-'+which);if(el)el.classList.add('active');window.scrollTo({top:0,behavior:'smooth'})}
...
function renderFlashcards(items){const box=$('studyAiFlashcardList');if(!box)return;box.innerHTML=(items||[]).map((c,i)=>`<article class="study-ai-card" data-card="${i}"><b>${i+1}. ${esc(c.front)}</b><details><summary>Hiện đáp án</summary><p>${esc(c.back)}</p>${c.hint?`<small>Gợi ý: ${esc(c.hint)}</small>`:''}</details><div class="actions"><button class="btn sm" onclick="studyAiMarkCard(${i},true)">✅ Đúng</button><button class="btn sm light" onclick="studyAiMarkCard(${i},false)">❌ Sai</button></div></article>`).join('')||'<p class="muted">Chưa có Flashcard. Hãy nhập JSON từ AI.</p>'}
...
function importFlash(){try{const x=JSON.parse($('studyAiFlashJson').value);const items=x.flashcards||x;if(!Array.isArray(items)||!items.length)throw Error();data.flashcards.push({id:Date.now(),author:$('studyAiFlashAuthor').value||'Thành viên',sharing:$('studyAiFlashSharing').value,items,createdAt:new Date().toISOString()});save();renderFlashcards(items);toast('✅ Đã nhập Flashcard từ JSON AI.')}catch(e){toast('❌ JSON Flashcard chưa hợp lệ. Hãy dán từ dấu { đầu tiên đến dấu } cuối cùng.')}}
function importExam(){try{const x=JSON.parse($('studyAiExamJson').value);if(!Array.isArray(x.questions)||!x.questions.length)throw Error();data.exams.push(Object.assign({},x,{id:Date.now(),author:$('studyAiExamAuthor').value||'Thành viên',sharing:$('studyAiExamSharing').value,createdAt:new Date().toISOString()}));save();renderExam(x);toast('✅ Đã nhập đề thi từ JSON AI.')}catch(e){toast('❌ JSON đề thi chưa hợp lệ. Hãy dán đủ cấu trúc exam_title/questions.')}}
function renderExam(x){const box=$('studyAiExamList');if(!box)return;box.innerHTML=`<h3>${esc(x.exam_title||'Bài kiểm tra')}</h3>`+(x.questions||[]).map(q=>`<div class="study-ai-card"><b>Câu ${esc(q.question_number)}. ${esc(q.question_text)}</b><div>${(q.options||[]).map(o=>`<label style="display:block;margin:6px 0"><input type="radio" name="studyExam${q.question_number}" value="${esc(o.slice(0,1))}"> ${esc(o)}</label>`).join('')}</div><small>Đáp án sẽ được giải thích sau khi nộp bài.</small></div>`).join('')+`<button class="btn" onclick="studyAiGradeExam()">📊 Nộp bài và xem kết quả</button>`;window.currentStudyExam=x}
...
function buildViews(){if($('studyAi-flashcards'))return;const main=document.querySelector('main');if(!main)return;const wrap=document.createElement('div');wrap.innerHTML=`<section id="studyAi-flashcards" class="view study-ai-view"><div class="card"><h2>🧠 AI Flashcard Generator</h2><p>Tạo thẻ ghi nhớ từ tài liệu bằng JSON do AI trả về.</p><div class="study-ai-disclaimer">⚠️ Bộ Flashcard được tổng hợp và duyệt tự động bởi AI. Nội dung có thể có sai sót nhỏ. Nếu phát hiện lỗi, hãy gửi tại Hòm thư Góp ý.</div><div class="study-ai-grid"><div class="study-ai-box"><h3>1. Thông tin & chia sẻ</h3><label>Tác giả<input id="studyAiFlashAuthor" placeholder="Tên User / Avatar"></label><label>Chế độ<select id="studyAiFlashSharing"><option value="private">🔒 Riêng tư</option><option value="friends">👥 Bạn bè</option><option value="public">🌍 Công khai</option></select></label><button class="btn sm light" onclick="copy(${JSON.stringify(flashPrompt)})">📋 Sao chép Prompt AI</button></div><div class="study-ai-box"><h3>2. Nhập JSON AI</h3><textarea id="studyAiFlashJson" placeholder="Dán JSON flashcards vào đây..."></textarea><button class="btn" onclick="studyAiImportFlash()">✨ Nhập Flashcard</button></div></div><div id="studyAiFlashcardList" style="margin-top:14px"></div></div></section><section id="studyAi-exam" class="view study-ai-view"><div class="card"><h2>📝 File-to-Exam Converter</h2><p>Chuyển bài tập và đáp án thành đề thi JSON để ôn tập.</p><div class="study-ai-disclaimer">⚠️ Đề kiểm tra và đáp án được bóc tách tự động bởi AI, chưa qua phê duyệt thủ công. Kết quả chỉ mang tính tham khảo.</div><div class="study-ai-grid"><div class="study-ai-box"><h3>1. Thông tin & chia sẻ</h3><label>Tác giả<input id="studyAiExamAuthor" placeholder="Tên User / Avatar"></label><label>Chế độ<select id="studyAiExamSharing"><option value="private">🔒 Riêng tư</option><option value="friends">👥 Bạn bè</option><option value="public">🌍 Công khai</option></select></label><button class="btn sm light" onclick="copy(${JSON.stringify(examPrompt)})">📋 Sao chép Prompt AI</button></div><div class="study-ai-box"><h3>2. Nhập JSON AI</h3><textarea id="studyAiExamJson" placeholder="Dán JSON đề thi vào đây..."></textarea><button class="btn" onclick="studyAiImportExam()">✨ Nhập đề thi</button></div></div><div id="studyAiExamList" style="margin-top:14px"></div><div id="studyAiExamResult"></div></div></section><section id="studyAi-contribution" class="view study-ai-view"><div class="card"><h2>🏆 Đóng góp & Phần thưởng</h2><p>Đóng góp tài liệu/bài tập tích lũy XP và điểm thành tích. Role đóng góp chỉ mở ở hai bậc cao nhất.</p><button class="btn" onclick="studyAiAddContribution()">📚 Ghi nhận đóng góp tài liệu</button><div id="studyAiRewards" style="margin-top:12px"></div><div class="study-ai-box"><h3>📮 Hòm thư Góp ý</h3><input id="studyAiFeedbackAuthor" placeholder="Tên người gửi"><select id="studyAiFeedbackType"><option>Flashcard — Báo lỗi nội dung</option><option>Đề thi — Báo lỗi định dạng/đáp án</option><option>Góp ý cải thiện website</option></select><textarea id="studyAiFeedbackText" placeholder="Nội dung góp ý..."></textarea><button class="btn" onclick="studyAiSubmitFeedback()">📮 Gửi góp ý</button></div><div id="studyAiInbox" class="study-ai-box" style="margin-top:14px"><h3>📂 Hòm thư Admin/Founder</h3><div id="studyAiInboxList"></div></div></div></section>`;while(wrap.firstElementChild)main.appendChild(wrap.firstElementChild);renderFlashcards(data.flashcards.at(-1)?.items||[]);renderRewards();renderInbox()}
window.studyAiImportFlash=importFlash;window.studyAiImportExam=importExam;window.studyAiOpen=()=>openView('flashcards');function boot(){buildViews();addNav();if(typeof state!=='undefined'&&state.sessionAuth?.role!=='Founder'){$('studyAiInbox')?.classList.add('muted')}}window.addEventListener('load',boot);setTimeout(boot,500);setTimeout(boot,1500);
})();
</script>

<style id="achievement-900-public-css">
.a900-hub{margin:12px 0;padding:15px;border:1px solid #c4b5fd;border-radius:18px;background:linear-gradient(135deg,#fffdf0,#eff6ff)}.a900-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px}.a900-grid input,.a900-grid textarea,.a900-grid select{width:100%;box-sizing:border-box;padding:8px;border:1px solid #cbd5e1;border-radius:10px}.a900-wide{grid-column:1/-1}.a900-item{padding:10px;border:1px solid #dbeafe;border-radius:12px;background:#ffffffc9;margin-top:7px}.a900-mythic{border-color:#eab308;background:linear-gradient(135deg,#fff7cc,#fff)}.a900-infinite{border-color:#8b5cf6;background:linear-gradient(135deg,#eef2ff,#fdf2f8)}.a900-badge{display:inline-flex;align-items:center;gap:6px;padding:5px 9px;border-radius:999px;font-weight:800;background:#fff;border:1px solid #facc15}.a900-hidden{opacity:.65}@media(max-width:700px){.a900-grid{grid-template-columns:1fr}.a900-wide{grid-column:auto}}
</style>
<script id="achievement-900-public-js">
(function(){'use strict';
...
window.toggleAContent=function(type,id){ensureA();const arr=type==='flashcard'?state.publicFlashcards:state.publicExams;const x=arr.find(v=>String(v.id)===String(id));if(!x)return;x.visibility=x.visibility==='hidden'?'public':'hidden';saveA();renderAHub()};
window.editAContent=function(type,id){ensureA();const arr=type==='flashcard'?state.publicFlashcards:state.publicExams,x=arr.find(v=>String(v.id)===String(id));if(!x)return;const title=prompt('Tên/nội dung mới:',x.title||x.front||x.question||'');if(title===null)return;x.title=title;x.updatedAt=new Date().toISOString();saveA();renderAHub()};
window.deleteAContent=function(type,id){ensureA();const arr=type==='flashcard'?state.publicFlashcards:state.publicExams,x=arr.find(v=>String(v.id)===String(id));if(!x)return;if(!confirm('Xóa nội dung? Điểm thành tích đã nhận không mất; hệ thống ghi nhận một khoản bù trừ để khôi phục khi bạn tạo nội dung thay thế.'))return;x.deleted=true;x.deletedAt=new Date().toISOString();const c=state.achievementContribution[ownerA()];c.deletedCompensation=Number(c.deletedCompensation||0)+10;state.feedbackInbox.push({id:'comp-'+Date.now(),type:'system',ownerId:ownerA(),status:'approved',message:'Bù trừ thành tích sau khi xóa nội dung',createdAt:new Date().toISOString()});saveA();renderAHub()};
...
function renderAHub(){const host=$('achievements')||$('profile');if(!host)return;let box=$('a900Hub');if(!box){box=document.createElement('div');box.id='a900Hub';box.className='a900-hub';host.prepend(box)}ensureA();const id=ownerA(),fs=state.publicFlashcards.filter(x=>!x.deleted),es=state.publicExams.filter(x=>!x.deleted),st=statsA(id),unlocked=(state.unlockedAchievements||[]);box.innerHTML=`<h3 style="margin-top:0">🏆 Thành tích — 900 thành tích / 11 mục</h3><p class="muted">Chỉ Flashcard và Đề thi ở chế độ <b>Công khai</b> mới được tính đóng góp. Nội dung có thể chỉnh sửa, ẩn/hiện hoặc xóa. Khi xóa, điểm đã nhận được bảo toàn và ghi một khoản bù trừ.</p><div class="a900-badge">⚡ ${st.points} điểm đóng góp · Tiến độ thành tích theo nội dung công khai</div><div style="margin-top:8px;font-size:12px;font-weight:800">Mốc: ${CONTRIBUTION_MILESTONES.map(m=>`${st.points>=m?'✅':'⬜'} ${m}`).join(' · ')}</div><div style="height:9px;background:#e2e8f0;border-radius:99px;margin-top:6px;overflow:hidden"><div style="width:${Math.min(100,st.points/TOTAL_CONTRIBUTION_POINTS*100)}%;height:100%;background:linear-gradient(90deg,#22c55e,#facc15,#8b5cf6)"></div></div> <button class="btn sm light" onclick="exportAContent()">💾 Xuất dữ liệu công khai</button><div class="a900-item"><b>📚 Flashcard công khai (${fs.length})</b>${fs.slice(-12).map(x=>`<div class="a900-item ${x.visibility==='hidden'?'a900-hidden':''}"><b>${escA(x.title||x.front||'Flashcard')}</b><small class="muted"> · ${x.visibility==='hidden'?'Đang ẩn':'Đang hiện'}</small><br><button class="btn sm light" onclick="editAContent('flashcard','${escA(x.id)}')">✏️ Sửa</button> <button class="btn sm light" onclick="toggleAContent('flashcard','${escA(x.id)}')">${x.visibility==='hidden'?'👁️ Hiện':'🙈 Ẩn'}</button> <button class="btn sm danger" onclick="deleteAContent('flashcard','${escA(x.id)}')">Xóa</button></div>`).join('')||'<span class="muted">Chưa có.</span>'}</div><div class="a900-item"><b>📝 Đề thi công khai (${es.length})</b>${es.slice(-12).map(x=>`<div class="a900-item ${x.visibility==='hidden'?'a900-hidden':''}"><b>${escA(x.title||x.exam_title||'Đề thi')}</b><small class="muted"> · ${x.visibility==='hidden'?'Đang ẩn':'Đang hiện'}</small><br><button class="btn sm light" onclick="editAContent('exam','${escA(x.id)}')">✏️ Sửa</button> <button class="btn sm light" onclick="toggleAContent('exam','${escA(x.id)}')">${x.visibility==='hidden'?'👁️ Hiện':'🙈 Ẩn'}</button> <button class="btn sm danger" onclick="deleteAContent('exam','${escA(x.id)}')">Xóa</button></div>`).join('')||'<span class="muted">Chưa có.</span>'}</div><div class="a900-item"><b>🌟 Mốc Role/Huy hiệu</b>${defsA.filter(x=>x.role).map(x=>`<div class="${x.tier==='Vô Cực'?'a900-infinite':'a900-mythic'} a900-item"><b>${x.icon} ${x.name}</b> · Role: ${x.role} · Huy hiệu: ${x.badge}<br><small>${x.effect}</small></div>`).join('')}</div>`}
...
<style id="role-requirements-v2-style">
/* V2: ẩn đúng các control kích thước/hướng dẫn, không đổi renderer kích thước Role */
[id*="RoleScale"],[id*="roleScale"],[id*="role-scale"],.role-scale-control,.role-size-control,.role-workshop-scale,.role-workshop-size,.role-size-help{display:none!important}
.role-origin-clickable{cursor:pointer}
.rqv2-ai-card{margin:10px 0;padding:12px;border:1px solid #a5b4fc;border-radius:16px;background:linear-gradient(135deg,#fff7ed,#eff6ff)}
.rqv2-ai-card textarea{width:100%;min-height:90px;box-sizing:border-box;border:1px solid #cbd5e1;border-radius:10px;padding:9px}.rqv2-admin-collapse{display:flex;justify-content:space-between;align-items:center;width:100%;margin-bottom:8px}.rqv2-admin-collapsed>*:not(.rqv2-admin-collapse){display:none!important}
</style>
<script id="role-requirements-v2-js">
(function(){
...
<style id="restore-original-mythic-infinite-preview">
/* Restored verbatim in meaning from 9(1): moving backgrounds, glow, and capsule pulse. */
.tier-preview-vo-cuc{background-size:240% 240%!important;animation:voCucFlow 5s ease-in-out infinite!important;box-shadow:inset 0 0 26px rgba(96,165,250,.35),0 0 20px rgba(59,130,246,.25)!important}
.tier-preview-vo-cuc .role-capsule{animation:voCucPulse 3.8s ease-in-out infinite!important;filter:none!important}
.tier-preview-than-thoai{background-size:300% 300%!important;animation:thanThoaiMorph 3.2s linear infinite!important;box-shadow:inset 0 0 32px rgba(250,204,21,.38),0 0 28px rgba(168,85,247,.4)!important}
.tier-preview-than-thoai .role-capsule{animation:thanThoaiPulse 2.6s ease-in-out infinite!important;filter:none!important}
.tier-preview-than-thoai .role-corner{animation-duration:2.6s!important}
.achievement-group[data-tier="vo-cuc"]::before,.achievement-group[data-tier="than-thoai"]::before,.achievement-group[data-tier="vo-cuc"]::after,.achievement-group[data-tier="than-thoai"]::after{animation-play-state:running!important}
...
<script id="public-content-visibility-guard-v1">
(function(){
  const oldFlash=window.renderFlashcards;
  if(typeof oldFlash==='function'&&!oldFlash.__publicGuard){
    window.renderFlashcards=function(items){
      const me=typeof accountOwnerId==='function'?accountOwnerId():(window.state?.sessionAuth?.memberId||'');
      const founder=window.state?.sessionAuth?.role==='Founder';
      const safe=(items||[]).filter(x=>founder||String(x.ownerId||x.authorId||'')===String(me)||(x.visibility||'public')==='public');
      return oldFlash.call(this,safe);
    };
    window.renderFlashcards.__publicGuard=true;
  }
  const oldExam=window.renderExam;
  if(typeof oldExam==='function'&&!oldExam.__publicGuard){
    window.renderExam=function(x){
      const me=typeof accountOwnerId==='function'?accountOwnerId():(window.state?.sessionAuth?.memberId||'');
      const founder=window.state?.sessionAuth?.role==='Founder';
      if(x&&!founder&&String(x.ownerId||x.authorId||'')!==String(me)&&(x.visibility||'public')!=='public'){
        const box=document.getElementById('studyAiExamList'); if(box) box.innerHTML='<p class="muted">Đề thi này đang được ẩn với thành viên khác.</p>'; return;
      }
      return oldExam.call(this,x);
    };
    window.renderExam.__publicGuard=true;
  }
})();
</script>
...
<script>document.addEventListener('DOMContentLoaded',finalRefreshLevelPanels);</script>

<script>try{finalRefreshLevelPanels();}catch(e){}</script>
...
(function(){
  ...
  function sessionCount(d){ return (d.sessions||[]).length; }
  ...
  renderAchievementsView=function(){
    ...
    container.querySelectorAll('.achievement').forEach(card=>{
      ...
      const cardRole=ach.roleReward||achievementRoleFor(ach); const roleLine=cardRole?` · 🎭 Role: ${esc(cardRole.name)}`:'';
      body.insertAdjacentHTML('beforeend',`<div class="achievement-role-inline" style="margin-top:7px"><span class="tag sm" style="${achievementBadgeStyle(ach)}">🏅 ${esc(ach.badge.name)} · ${esc(p.label)}</span><span class="kpi" style="display:block;margin-top:4px;color:${p.accent}">📈 ${esc(achievementProgressText(ach,ownerId))}${roleLine}</span></div>`);
    });
  };
  ...
  openAchievementDetail=function(id){
    ...
    const roleHtml=achievementRoleDescription(ach.roleReward||achievementRoleFor(ach),ach);
  ...
  function tierPreviewRole(tier){
    const own=currentPreviewOwnerId();const real=own?getCustomRolesForMember(own).find(r=>r&&r.visibility!=='hidden')||getCustomRolesForMember(own)[0]:null;if(real)return real;
    if(tier==='vo-cuc')return roleSchema({id:'preview-vo-cuc',name:'Người du hành vô cực',icon:'🌌',color1:'#312e81',color2:'#38bdf8',gradientCss:'radial-gradient(circle at 25% 20%,#818cf8,transparent 25%),linear-gradient(135deg,#020617,#312e81,#0ea5e9)',visibility:'public',effects:{animation:'energy-wave',style:'Space',speed:3.8,strength:1.8,size:1,cornerIcons:['✦','🪐','✨','🌟'],decorColor:'#bfdbfe',decorBg:'rgba(15,23,42,.72)',cornerCount:4}});
    return roleSchema({id:'preview-than-thoai',name:'Kẻ gọi ánh sáng',icon:'💠',color1:'#581c87',color2:'#facc15',gradientCss:'radial-gradient(circle at 70% 20%,#facc15,transparent 20%),linear-gradient(135deg,#09090b,#581c87,#a16207)',visibility:'public',effects:{animation:'star-orbit',style:'Mystery',speed:2.6,strength:2.5,size:1.08,cornerIcons:['✧','💎','👑','⚡'],decorColor:'#fde68a',decorBg:'rgba(24,10,40,.76)',cornerCount:4}});
  }
